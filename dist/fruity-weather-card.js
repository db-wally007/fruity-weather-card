...
let y = class extends q {
  ...
  _iconUrl(e) {
    ...
    return t ? `${t.replace(/\/+$/, "")}/${e}.png` : new URL((/* @__PURE__ */ Object.assign({ "../icons/clear.png": ge, "../icons/cloudy.png": ue, "../icons/drizzle.png": Ae, "../icons/fog.png": fe, "../icons/freezing_rain.png": me, "../icons/haze.png": we, "../icons/heavy_rain.png": ye, "../icons/heavy_snow.png": be, "../icons/night_clear.png": ve, "../icons/night_cloudy.png": xe, "../icons/night_drizzle.png": _e, "../icons/partly_cloudy.png": ke, "../icons/rain.png": Ce, "../icons/snow.png": Oe, "../icons/sunrise.png": Be, "../icons/sunset.png": Se, "../icons/thunderstorm.png": Ee, "../icons/windy.png": Me }))[`../icons/${e}.png`], import.meta.url).href;
  }
  // -- render ---------------------------------------------------------------
  render() {
