 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Re, defineProperty: Ie, getOwnPropertyDescriptor: Te, getOwnPropertyNames: He, getOwnPropertySymbols: Pe, getPrototypeOf: Ue } = Object, ht = globalThis, Et = ht.trustedTypes, Qe = Et ? Et.emptyScript : "", ze = ht.reactiveElementPolyfillSupport, K = (e, t) => e, at = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? Qe : null;
      break;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const At = globalThis, Mt = (e) => e, ot = At.trustedTypes, $t = ot ? ot.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, Lt = "$lit$", R = `lit$${Math.random().toFixed(9).slice(2)}$`, Nt = "?" + R, je = `<${Nt}>`, U = document, q = () => U.createComment(""), W = (e) => e === null || typeof e != "object" && typeof e != "function", ft = Array.isArray, Le = (e) => ft(e) || typeof e?.[Symbol.iterator] == "function", dt = `[ 	
      ...
      if (a.nodeType === 1) {
        ...
        if (Ft.test(a.tagName)) {
          ...
          if (d > 0) {
            ...
            for (let g = 0; g < d; g++) a.append(h[g], q()), P.nextNode(), l.push({ type: 2, index: ++o });
            a.append(h[d], q());
          }
        }
...
var yi = Object.defineProperty, bi = Object.getOwnPropertyDescriptor, E = (e, t, i, s) => {
...
let y = class extends G {
  ...
  updated(e) {
    super.updated(e), (e.has("hass") || e.has("_config")) && this.hass && this._config && (this._subscribedTo !== this._config.entity && this._subscribe(), this._config.map && this._watchMapVisible()), this._config?.map && (this._paintMap(), this._syncMapBar(), this._watchMapSize()), this._sheetDay !== null && this._positionSheet();
  }
  /* ------------------------------------------------ precipitation map ---- */
  /**
