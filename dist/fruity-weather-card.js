...
let G = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(ht("properties"))) {
      const s = this.properties, i = [...je(s), ...Qe(s)];
  ...
  _$ET(t, s) {
    ...
    if (a !== void 0 && i.reflect === !0) {
      const o = (i.converter?.toAttribute !== void 0 ? i.converter : yt).toAttribute(s, i.type);
  ...
  _$AK(t, s) {
    ...
    if (a !== void 0 && this._$Em !== a) {
      const o = i.getPropertyOptions(a), r = typeof o.converter == "function" ? { fromAttribute: o.converter } : o.converter?.fromAttribute !== void 0 ? o.converter : yt;
      this._$Em = a;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const $t = globalThis, zt = (e) => e, wt = $t.trustedTypes, jt = wt ? wt.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, Wt = "$lit$", j = `lit$${Math.random().toFixed(9).slice(2)}$`, Zt = "?" + j, Xe = `<${Zt}>`, F = document, dt = () => F.createComment(""), ct = (e) => e === null || typeof e != "object" && typeof e != "function", Et = Array.isArray, Ve = (e) => Et(e) || typeof e?.[Symbol.iterator] == "function", kt = `[ 	
\f\r]`, at = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Qt = /-->/g, Lt = />/g, Q = RegExp(`>|${kt}(?:([^\\s"'>=/]+)(${kt}*=${kt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Nt = /'/g, Ft = /"/g, te = /^(?:script|style|textarea|title)$/i, ee = (e) => (t, ...s) => ({ _$litType$: e, strings: t, values: s }), y = ee(1), M = ee(2), q = Symbol.for("lit-noChange"), w = Symbol.for("lit-nothing"), Xt = /* @__PURE__ */ new WeakMap(), N = F.createTreeWalker(F, 129);
function ie(e, t) {
...
const Ye = (e, t) => {
  ...
  for (let n = 0; n < s; n++) {
    ...
    o += r === at ? l + Xe : d >= 0 ? (i.push(h), l.slice(0, d) + Wt + l.slice(d) + j + p) : l + j + (d === -2 ? n : p);
  }
...
class pt {
  constructor({ strings: t, _$litType$: s }, i) {
    ...
    this.parts = [];
    let o = 0, r = 0;
    const n = t.length - 1, l = this.parts, [h, u] = Ye(t, s);
    ...
    for (; (a = N.nextNode()) !== null && l.length < n; ) {
      if (a.nodeType === 1) {
        if (a.hasAttributes()) for (const d of a.getAttributeNames()) if (d.endsWith(Wt)) {
          ...
          l.push({ type: 1, index: o, name: g[2], strings: p, ctor: g[1] === "." ? Je : g[1] === "?" ? qe : g[1] === "@" ? Ke : _t }), a.removeAttribute(d);
...
class Ge {
  ...
  u(t) {
    ...
    for (; l !== void 0; ) {
      if (r === l.index) {
        let h;
        l.type === 2 ? h = new ut(o, o.nextSibling, this, t) : l.type === 1 ? h = new l.ctor(o, l.name, l.strings, this, t) : l.type === 6 && (h = new We(o, this, t)), this._$AV.push(h), l = i[++n];
      }
...
class ut {
  ...
  constructor(t, s, i, a) {
    this.type = 2, this._$AH = w, this._$AN = void 0, this._$AA = t, this._$AB = s, this._$AM = i, this.options = a, this._$Cv = a?.isConnected ?? !0;
  }
  get parentNode() {
  ...
  _$AI(t, s = this) {
    t = K(this, t, s), ct(t) ? t === w || t == null || t === "" ? (this._$AH !== w && this._$AR(), this._$AH = w) : t !== this._$AH && t !== q && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Ve(t) ? this.k(t) : this._(t);
  }
  O(t) {
...
class _t {
  ...
  constructor(t, s, i, a, o) {
    this.type = 1, this._$AH = w, this._$AN = void 0, this.element = t, this.name = s, this._$AM = a, this.options = o, i.length > 2 || i[0] !== "" || i[1] !== "" ? (this._$AH = Array(i.length - 1).fill(new String()), this.strings = i) : this._$AH = w;
  }
  _$AI(t, s = this, i, a) {
    ...
    if (o === void 0) t = K(this, t, s, 0), r = !ct(t) || t !== this._$AH && t !== q, r && (this._$AH = t);
      ...
      const n = t;
      let l, h;
      for (t = o[0], l = 0; l < o.length - 1; l++) h = K(this, n[i + l], s, l), h === q && (h = this._$AH[l]), r ||= !ct(h) || h !== this._$AH[l], h === w ? t = w : t !== w && (t += (h ?? "") + o[l + 1]), this._$AH[l] = h;
    }
    r && !a && this.j(t);
  }
  j(t) {
...
class Ke extends _t {
  ...
  _$AI(t, s = this) {
    if ((t = K(this, t, s, 0) ?? w) === q) return;
    const i = this._$AH, a = t === w && i !== w || t.capture !== i.capture || t.once !== i.once || t.passive !== i.passive, o = t !== w && (i === w || a);
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const si = { attribute: !0, type: String, converter: yt, reflect: !1, hasChanged: Ot }, ai = (e = si, t, s) => {
...
function se(e) {
  return (t, s) => typeof s == "object" ? ai(e, t, s) : ((i, a, o) => {
...
async function ni(e, t) {
  try {
    const s = await fetch(`${ri}?t=${Math.floor(Date.now() / 6e4)}`);
    if (!s.ok) return;
...
async function hi(e, t) {
  const s = await ni(e, t);
  if (s) return s;
  const i = [], a = [];
  for (let m = 0; m < $; m++)
    for (let f = 0; f < B; f++)
      i.push((e + (m - ($ - 1) / 2) * Z).toFixed(4)), a.push((t + (f - (B - 1) / 2) * W).toFixed(4));
  const o = `https://api.open-meteo.com/v1/forecast?latitude=${i.join(",")}&longitude=${a.join(",")}&hourly=precipitation&forecast_hours=13&minutely_15=precipitation&forecast_minutely_15=8&timezone=UTC`, r = li(e, t);
  if (r) return r;
  ...
  const u = (m) => (/* @__PURE__ */ new Date(`${m}Z`)).getTime(), d = h[0].hourly.time.map(u), c = h[0].minutely_15.time.map(u), p = (m, f) => Array.from({ length: m }, (x, v) => {
    ...
    hourly: {
      times: d,
      frames: p(d.length, (m, f) => m.hourly.precipitation[f])
    },
    quarter: {
      times: c,
      frames: p(c.length, (m, f) => m.minutely_15.precipitation[f])
    }
  };
  return di(g), g;
}
...
function ci(e, t, s, i, a) {
  return {
    z: s,
    originX: bt(t, s) * 256 - i / 2,
    originY: vt(e, s) * 256 - a / 2,
    width: i,
    height: a
  };
}
...
const fi = J.slice(1).map(([e, t, s, i]) => `rgb(${t},${s},${i}) ${((e / 15) ** 0.45 * 100).toFixed(0)}%`).join(", ");
function mi(e, t, s, i) {
  ...
  const p = oi(t.lat0, t.lon0), g = (bt(p.west, i.z) * 256 - i.originX) * a, m = (bt(p.east, i.z) * 256 - i.originX) * a, f = (vt(p.north, i.z) * 256 - i.originY) * a, x = (vt(p.south, i.z) * 256 - i.originY) * a;
  n.imageSmoothingEnabled = !0, n.imageSmoothingQuality = "high", n.drawImage(d, g, f, m - g, x - f);
}
function Ai(e, t, s, i) {
...
function he(e) {
  ...
  for (let s = 0; s < e.time.length; s++) {
    ...
    l.push({
      ...
      time: n,
      temp: a,
      condition: vi(e.weather_code[s] ?? 3),
...
async function _i() {
  try {
    ...
    const s = /* @__PURE__ */ new Map(), i = t.daily?.time ?? [], a = t.daily?.precipitation_probability_max ?? [];
    for (let o = 0; o < i.length; o++) s.set(i[o], a[o] ?? 0);
    return { fetchedAt: t.fetchedAt, days: he(t.hourly), dayProb: s };
  } catch {
    return;
  }
}
...
async function Si(e, t, s = !1) {
  ...
  const l = n.length, h = (m) => m ?? new Array(l).fill(null), u = he({
    time: n,
  ...
  }), d = /* @__PURE__ */ new Map(), c = r.daily?.time ?? [], p = r.daily?.precipitation_probability_max ?? [];
  for (let m = 0; m < c.length; m++) d.set(c[m], p[m] ?? 0);
  const g = { fetchedAt: Date.now(), days: u, dayProb: d };
  return Vt(g), g;
}
function St(e) {
...
var Ci = Object.defineProperty, Bi = Object.getOwnPropertyDescriptor, O = (e, t, s, i) => {
  for (var a = i > 1 ? void 0 : i ? Bi(t, s) : t, o = e.length - 1, r; o >= 0; o--)
    (r = e[o]) && (a = (i ? r(t, s, a) : r(a)) || a);
  return i && a && Ci(t, s, a), a;
};
const Oi = Kt(fi), $i = 20, Ei = /* @__PURE__ */ new Set([
  "rainy",
  "pouring",
  "snowy",
  "snowy-rainy",
...
let b = class extends lt {
  ...
  async _ensureHourly(e = !1) {
    ...
    if (!(t === void 0 || s === void 0 || this._hourlyPending) && !(!e && this._hourlyDays && Date.now() - this._hourlyDays.fetchedAt < Dt) && !(!e && Date.now() < this._hourlyRetryAt)) {
      ...
      try {
        this._hourlyDays = await ki(t, s, e), this._hourlyBackoff = 0, this._hourlyRetryAt = 0;
      } catch (i) {
  ...
  _dayProb(e) {
    ...
    const s = this._hourlyDays.dayProb.get(St(new Date(t.datetime)));
  ...
  _printableProb(e, t) {
    if (t !== void 0)
      return t >= $i || e && Ei.has(e) ? t : void 0;
  }
  /**
  ...
  _paintMap() {
    ...
    const i = ci(t.lat, t.lon, this._zoom, s.width, s.height), a = this._mapViewport;
    ...
    let d = r.frames[h];
    u !== h && ((!this._mapScratch || this._mapScratch.length !== d.length) && (this._mapScratch = new Float32Array(d.length)), d = Ai(r.frames[h], r.frames[u], l - h, this._mapScratch)), mi(o, this._grid, d, i);
  }
  /**
  ...
  _timeLabel(e, t = !1) {
    ...
    return y`${s}${i ? y`<span class="ap">${i}</span>` : w}`;
  }
  /**
  ...
  _iconUrl(e) {
    ...
    return t ? `${t.replace(/\/+$/, "")}/${e}.png` : new URL((/* @__PURE__ */ Object.assign({ "../icons/clear.png": Ae, "../icons/cloudy.png": ye, "../icons/drizzle.png": we, "../icons/fog.png": be, "../icons/freezing_rain.png": ve, "../icons/haze.png": xe, "../icons/heavy_rain.png": _e, "../icons/heavy_snow.png": ke, "../icons/night_clear.png": Se, "../icons/night_cloudy.png": Ce, "../icons/night_drizzle.png": Be, "../icons/partly_cloudy.png": Oe, "../icons/rain.png": $e, "../icons/snow.png": Ee, "../icons/sunrise.png": Me, "../icons/sunset.png": De, "../icons/thunderstorm.png": Re, "../icons/windy.png": Ie }))[`../icons/${e}.png`], import.meta.url).href;
  }
  // -- render ---------------------------------------------------------------
  render() {
  ...
  _renderHero(e) {
    const t = this._config.name ?? e.attributes.friendly_name ?? this._config.entity, s = this._override("temperature", "temperature"), i = this._daily[0], a = H(i?.temperature), o = H(i?.templow), r = Gt[e.state] ?? e.state, n = this._tap("hero"), l = this._heroScene(e.state), h = this._config, u = (p) => typeof p == "number" ? `${p}px` : p, d = [], c = (h.backgrounds_path ?? Mi).replace(/\/+$/, "");
    return l && d.push(`--fwc-hero: url("${c}/hero-${l}.jpg?v=2")`), h.hero_bleed_x !== void 0 && d.push(`--fwc-hero-bleed-x: ${u(h.hero_bleed_x)}`), h.hero_bleed_top !== void 0 && d.push(`--fwc-hero-bleed-top: ${u(h.hero_bleed_top)}`), h.hero_extend !== void 0 && d.push(`--fwc-hero-extend: ${u(h.hero_extend)}`), h.hero_radius !== void 0 && d.push(`--fwc-hero-radius: ${u(h.hero_radius)}`), y`
  ...
  _renderHourly() {
    ...
    this._hourly.forEach((p, g) => {
      const m = new Date(p.datetime);
      if (m.getTime() > s) return;
      const f = this._hourAt(m), x = f?.condition ?? p.condition ?? "";
      i.push({
        kind: "hour",
        time: m,
        label: g === 0 ? y`Now` : this._timeLabel(m),
        condition: x,
    ...
    return y`
      <div class="panel strip" ?tappable=${!!c}
        ...
        ${h ? y`<div class="strip-summary">${h}</div>` : w}
        <div class="row">
          ${i.map((p) => p.kind === "sun" ? y`
                <div class="cell">
                  <div class="cell-label">${p.label}</div>
                  <img class="cell-icon" src=${this._iconUrl(Ri[p.event])} alt=${p.event} />
                ...
                <div class="cell">
                  ...
                  <div class="cell-prob">${p.prob === void 0 ? w : y`${Math.round(p.prob)}%`}</div>
   ...
   */
  _nightAt(e) {
    const { rising: t, setting: s } = this._sunTimes();
    return !t || !s ? this._isNight : t < s ? e < t || e >= s : e >= s && e < t;
  }
  _renderDaily() {
    ...
    return y`
      <div class="panel daily" ?tappable=${!!l}
        ...
        ${e.map((h, u) => {
      const d = H(h.templow), c = H(h.temperature), p = new Date(h.datetime), g = u === 0 ? "Today" : p.toLocaleDateString(n, { weekday: "short" }), m = d === void 0 ? 0 : (d - i) / o * 100, f = d === void 0 || c === void 0 ? 0 : (c - d) / o * 100, x = u === 0 && r !== void 0 ? (r - i) / o * 100 : void 0;
      return y`
        ...
        return v === void 0 ? w : y`<span class="dprob">${Math.round(v)}%</span>`;
              ...
              <div class="track">
                <div class="bar" style=${`left:${m}%;width:${f}%;background:linear-gradient(90deg, ${Jt(d ?? i)}, ${Jt(c ?? a)})`}></div>
  ...
  _renderSheetBody(e, t, s) {
    ...
    const i = this._sheetMode === "precip", a = i ? "%" : "°", o = e.map((A) => i ? A.precipProb : A.temp), r = Math.max(...o), n = Math.min(...o), l = e[o.indexOf(r)], h = e[o.indexOf(n)];
    let u, d;
    const c = [];
    if (i)
    ...
    const p = Math.max(d - u, i ? 1 : 5), g = e.length, m = (A) => g > 1 ? A / (g - 1) * 100 : 50, f = (A) => (d - A) / p * 100, x = Date.now();
    let v = null;
    if (g > 1 && x > e[0].time && x < e[g - 1].time) {
      for (let A = 0; A < g - 1; A++)
        if (x < e[A + 1].time) {
          v = A + (x - e[A].time) / (e[A + 1].time - e[A].time);
          break;
        }
    }
    const S = (A) => v !== null && A < v, C = o.map((A, _) => `${m(_)},${f(A)}`).join(" ");
    let U = "", tt = C, et = "", X = `0,100 ${C} 100,100`;
    if (v !== null) {
      const A = Math.floor(v), _ = v - A, D = m(v), R = f(o[A] + (o[A + 1] - o[A]) * _), z = o.slice(0, A + 1).map((it, st) => `${m(st)},${f(it)}`).join(" "), V = o.slice(A + 1).map((it, st) => `${m(A + 1 + st)},${f(it)}`).join(" ");
    ...
    return y`
      ...
      <div class="sheet-glyphs">
        ${e.map((A, _) => _ % gt === 0 ? y`<img class="sglyph ${_ === 0 ? "first" : _ === g - 1 ? "last" : ""} ${S(_) ? "past" : ""}"
                      style=${`left:${m(_)}%`}
                      src=${this._iconUrl(rt(A.condition, this._nightAt(new Date(A.time))))}
                      alt=${A.condition} />` : w)}
      </div>
      ...
      this._hourScrub = null;
          ...
          ${c.map((A) => y`
            <div class="sgl" style=${`top:${f(A)}%`}></div>`)}
          ${v !== null ? y`<div class="now-line" style=${`left:${m(v)}%`}></div>` : w}
          ...
          <svg class="scurve ${i ? "precip" : ""}" viewBox="0 0 100 100" preserveAspectRatio="none">
            ...
            ${et ? M`<polygon points=${et} fill="url(#sfillpast)" />` : w}
            <polygon points=${X} fill="url(#sfill)" />
            ${U ? M`<polyline class="past" points=${U} vector-effect="non-scaling-stroke" />` : w}
            <polyline points=${tt} vector-effect="non-scaling-stroke" />
          </svg>
          ${i ? w : (() => {
      const A = f(r), _ = f(n), D = e.indexOf(l), R = e.indexOf(h);
      return y`
              <div class="smark hi ${A < 22 ? "flip" : ""} ${S(D) ? "past" : ""}"
                   style=${`left:${m(D)}%; top:${A}%`}>
                <span>H</span>
              </div>
              <div class="smark lo ${_ > 78 ? "flip" : ""} ${S(R) ? "past" : ""}"
                   style=${`left:${m(R)}%; top:${_}%`}>
                <span>L</span>
              </div>
            `;
    })()}
          ${T ? y`
                <div class="scrub-line ${i ? "precip" : ""}" style=${`left:${m(this._hourScrub)}%`}></div>
                <div class="scrub-dot" style=${`left:${m(this._hourScrub)}%; top:${f(ft)}%`}></div>
              ` : w}
        </div>
        <div class="sheet-yaxis">
          ${c.map((A) => y`<span style=${`top:${f(A)}%`}>${k(A)}${a}</span>`)}
        </div>
      </div>

      <div class="sheet-xaxis">
        ${e.map((A, _) => A.hour % 6 === 0 && A.hour !== 0 ? y`<span class="${_ === g - 1 ? "last" : ""} ${S(_) ? "past" : ""}"
                       style=${`left:${m(_)}%`}>${this._hourLabel(A.hour)}</span>` : w)}
      </div>
    `;
  }
  /**
  ...
  _renderMapTile() {
    ...
    const n = e ? this._mapSeries : void 0, l = n ? Math.min(this._mapFrame, n.frames.length - 1) : 0, h = n ? new Date(n.times[l]) : void 0, u = this._config?.map_style ?? "dark", d = t ? ui(t, u) : [];
    return y`
      ...
      c.stopPropagation(), this._toggleMap();
          ...
          ${this._mapOpen && n?.frames.length && h ? y`
  ...
  _renderWindTile(e, t, s, i, a) {
    ...
    for (let I = 0; I < 72; I++) {
      ...
      l += `M${pe.toFixed(2)},${ue.toFixed(2)}L${ge.toFixed(2)},${fe.toFixed(2)}`;
    }
    const h = a !== void 0, u = h ? a + 180 : 0, d = r(u), c = r(u + 180), p = 38, [g, m] = n(p, c), [f, x] = n(p - 3, c), [v, S] = n(24.5, c), [C, U] = n(22.5, d), [tt, et] = n(30, d), X = 1.32, gt = (p + 2 + 30) / 2, T = (p + 2 - 30) / 2 * X, [ft, A] = n(gt + T, d), [_, D] = n(gt - T, d), R = -Math.sin(d), z = Math.cos(d), V = 3.4 * X, it = _ + R * V, st = D + z * V, le = _ - R * V, de = D - z * V, ce = (I) => {
        ...
        <div class="wind-body">
          ...
          <svg class="dial" viewBox="0 0 96 96" aria-hidden="true">
            ...
            ${h ? M`
              ...
              <circle class="dial-tail" cx=${g.toFixed(2)} cy=${m.toFixed(2)}
                      r=${(3.2 * X).toFixed(2)}></circle>
              <polygon class="dial-head" points=${`${ft.toFixed(2)},${A.toFixed(2)} ${it.toFixed(2)},${st.toFixed(2)} ${le.toFixed(2)},${de.toFixed(2)}`}></polygon>` : w}
