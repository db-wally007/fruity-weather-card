...
const Kt = (e) => new qt(typeof e == "string" ? e : e + "", void 0, Bt), Te = (e, ...t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: He, defineProperty: Ue, getOwnPropertyDescriptor: ze, getOwnPropertyNames: je, getOwnPropertySymbols: Qe, getPrototypeOf: Le } = Object, xt = globalThis, Ht = xt.trustedTypes, Ne = Ht ? Ht.emptyScript : "", Fe = xt.reactiveElementPolyfillSupport, ht = (e, t) => e, yt = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? Ne : null;
      break;
  ...
  return i;
} }, Ot = (e, t) => !He(e, t), Ut = { attribute: !0, type: String, converter: yt, reflect: !1, useDefault: !1, hasChanged: Ot };
...
let G = class extends HTMLElement {
  ...
  static getPropertyDescriptor(t, i, s) {
    const { get: a, set: o } = ze(this.prototype, t) ?? { get() {
      return this[i];
    }, set(r) {
      this[i] = r;
    } };
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      ...
      for (const a of s) i.unshift(Pt(a));
  ...
  _$ET(t, i) {
    ...
    if (a !== void 0 && s.reflect === !0) {
      const o = (s.converter?.toAttribute !== void 0 ? s.converter : yt).toAttribute(i, s.type);
  ...
  _$AK(t, i) {
    ...
    if (a !== void 0 && this._$Em !== a) {
      const o = s.getPropertyOptions(a), r = typeof o.converter == "function" ? { fromAttribute: o.converter } : o.converter?.fromAttribute !== void 0 ? o.converter : yt;
      this._$Em = a;
  ...
  requestUpdate(t, i, s, a = !1, o) {
    if (t !== void 0) {
      ...
      if (a === !1 && (o = this[t]), s ??= r.getPropertyOptions(t), !((s.hasChanged ?? Ot)(o, i) || s.useDefault && s.reflect && o === this._$Ej?.get(t) && !this.hasAttribute(r._$Eu(t, s)))) return;
      this.C(t, i, s);
    }
...
G.elementStyles = [], G.shadowRootOptions = { mode: "open" }, G[ht("elementProperties")] = /* @__PURE__ */ new Map(), G[ht("finalized")] = /* @__PURE__ */ new Map(), Fe?.({ ReactiveElement: G }), (xt.reactiveElementVersions ??= []).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const $t = globalThis, zt = (e) => e, wt = $t.trustedTypes, jt = wt ? wt.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, Wt = "$lit$", j = `lit$${Math.random().toFixed(9).slice(2)}$`, Zt = "?" + j, Xe = `<${Zt}>`, F = document, dt = () => F.createComment(""), ct = (e) => e === null || typeof e != "object" && typeof e != "function", Mt = Array.isArray, Ve = (e) => Mt(e) || typeof e?.[Symbol.iterator] == "function", kt = `[ 	
\f\r]`, at = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Qt = /-->/g, Lt = />/g, Q = RegExp(`>|${kt}(?:([^\\s"'>=/]+)(${kt}*=${kt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Nt = /'/g, Ft = /"/g, te = /^(?:script|style|textarea|title)$/i, ee = (e) => (t, ...i) => ({ _$litType$: e, strings: t, values: i }), y = ee(1), E = ee(2), q = Symbol.for("lit-noChange"), w = Symbol.for("lit-nothing"), Xt = /* @__PURE__ */ new WeakMap(), N = F.createTreeWalker(F, 129);
function ie(e, t) {
...
const Ye = (e, t) => {
  ...
  for (let n = 0; n < i; n++) {
    const d = e[n];
    let l, p, h = -1, c = 0;
    for (; c < d.length && (r.lastIndex = c, p = r.exec(d), p !== null); ) c = r.lastIndex, r === at ? p[1] === "!--" ? r = Qt : p[1] !== void 0 ? r = Lt : p[2] !== void 0 ? (te.test(p[2]) && (a = RegExp("</" + p[2], "g")), r = Q) : p[3] !== void 0 && (r = Q) : r === Q ? p[0] === ">" ? (r = a ?? at, h = -1) : p[1] === void 0 ? h = -2 : (h = r.lastIndex - p[2].length, l = p[1], r = p[3] === void 0 ? Q : p[3] === '"' ? Ft : Nt) : r === Ft || r === Nt ? r = Q : r === Qt || r === Lt ? r = at : (r = Q, a = void 0);
    const u = r === Q && e[n + 1].startsWith("/>") ? " " : "";
    o += r === at ? d + Xe : h >= 0 ? (s.push(l), d.slice(0, h) + Wt + d.slice(h) + j + u) : d + j + (h === -2 ? n : u);
  }
...
class pt {
  constructor({ strings: t, _$litType$: i }, s) {
    ...
    this.parts = [];
    let o = 0, r = 0;
    const n = t.length - 1, d = this.parts, [l, p] = Ye(t, i);
    if (this.el = pt.createElement(l, s), N.currentNode = this.el.content, i === 2 || i === 3) {
      const h = this.el.content.firstChild;
      h.replaceWith(...h.childNodes);
    }
    for (; (a = N.nextNode()) !== null && d.length < n; ) {
      if (a.nodeType === 1) {
        if (a.hasAttributes()) for (const h of a.getAttributeNames()) if (h.endsWith(Wt)) {
          const c = p[r++], u = a.getAttribute(h).split(j), g = /([.?@])?(.*)/.exec(c);
          d.push({ type: 1, index: o, name: g[2], strings: u, ctor: g[1] === "." ? Je : g[1] === "?" ? qe : g[1] === "@" ? Ke : _t }), a.removeAttribute(h);
        } else h.startsWith(j) && (d.push({ type: 6, index: o }), a.removeAttribute(h));
        if (te.test(a.tagName)) {
          const h = a.textContent.split(j), c = h.length - 1;
          if (c > 0) {
            a.textContent = wt ? wt.emptyScript : "";
            for (let u = 0; u < c; u++) a.append(h[u], dt()), N.nextNode(), d.push({ type: 2, index: ++o });
            a.append(h[c], dt());
          }
        }
      } else if (a.nodeType === 8) if (a.data === Zt) d.push({ type: 2, index: o });
      else {
        let h = -1;
        for (; (h = a.data.indexOf(j, h + 1)) !== -1; ) d.push({ type: 7, index: o }), h += j.length - 1;
      }
      o++;
    }
  }
...
class Ge {
  ...
  u(t) {
    ...
    N.currentNode = a;
    let o = N.nextNode(), r = 0, n = 0, d = s[0];
    for (; d !== void 0; ) {
      if (r === d.index) {
        let l;
        d.type === 2 ? l = new ut(o, o.nextSibling, this, t) : d.type === 1 ? l = new d.ctor(o, d.name, d.strings, this, t) : d.type === 6 && (l = new We(o, this, t)), this._$AV.push(l), d = s[++n];
      }
      r !== d?.index && (o = N.nextNode(), r++);
    }
...
class ut {
  ...
  constructor(t, i, s, a) {
    this.type = 2, this._$AH = w, this._$AN = void 0, this._$AA = t, this._$AB = i, this._$AM = s, this.options = a, this._$Cv = a?.isConnected ?? !0;
  }
  get parentNode() {
  ...
  _$AI(t, i = this) {
    t = K(this, t, i), ct(t) ? t === w || t == null || t === "" ? (this._$AH !== w && this._$AR(), this._$AH = w) : t !== this._$AH && t !== q && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Ve(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== w && ct(this._$AH) ? this._$AA.nextSibling.data = t : this.T(F.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    const { values: i, _$litType$: s } = t, a = typeof s == "number" ? this._$AC(t) : (s.el === void 0 && (s.el = pt.createElement(ie(s.h, s.h[0]), this.options)), s);
    if (this._$AH?._$AD === a) this._$AH.p(i);
    else {
      const o = new Ge(a, this), r = o.u(this.options);
      o.p(i), this.T(r), this._$AH = o;
    }
  }
  _$AC(t) {
    let i = Xt.get(t.strings);
    return i === void 0 && Xt.set(t.strings, i = new pt(t)), i;
  }
  k(t) {
    Mt(this._$AH) || (this._$AH = [], this._$AR());
    const i = this._$AH;
    let s, a = 0;
    for (const o of t) a === i.length ? i.push(s = new ut(this.O(dt()), this.O(dt()), this, this.options)) : s = i[a], s._$AI(o), a++;
...
class _t {
  ...
  constructor(t, i, s, a, o) {
    this.type = 1, this._$AH = w, this._$AN = void 0, this.element = t, this.name = i, this._$AM = a, this.options = o, s.length > 2 || s[0] !== "" || s[1] !== "" ? (this._$AH = Array(s.length - 1).fill(new String()), this.strings = s) : this._$AH = w;
  }
  _$AI(t, i = this, s, a) {
    const o = this.strings;
    let r = !1;
    if (o === void 0) t = K(this, t, i, 0), r = !ct(t) || t !== this._$AH && t !== q, r && (this._$AH = t);
    else {
      const n = t;
      let d, l;
      for (t = o[0], d = 0; d < o.length - 1; d++) l = K(this, n[s + d], i, d), l === q && (l = this._$AH[d]), r ||= !ct(l) || l !== this._$AH[d], l === w ? t = w : t !== w && (t += (l ?? "") + o[d + 1]), this._$AH[d] = l;
    }
    r && !a && this.j(t);
  }
  j(t) {
...
class Ke extends _t {
  ...
  _$AI(t, i = this) {
    if ((t = K(this, t, i, 0) ?? w) === q) return;
    const s = this._$AH, a = t === w && s !== w || t.capture !== s.capture || t.once !== s.once || t.passive !== s.passive, o = t !== w && (s === w || a);
...
const Ze = $t.litHtmlPolyfillSupport;
Ze?.(pt, ut), ($t.litHtmlVersions ??= []).push("3.3.3");
const ti = (e, t, i) => {
  const s = i?.renderBefore ?? t;
  let a = s._$litPart$;
  if (a === void 0) {
    const o = i?.renderBefore ?? null;
    s._$litPart$ = a = new ut(t.insertBefore(dt(), o), o, void 0, i ?? {});
  }
  return a._$AI(e), a;
};
/**
...
lt._$litElement$ = !0, lt.finalized = !0, Et.litElementHydrateSupport?.({ LitElement: lt });
const ei = Et.litElementPolyfillSupport;
ei?.({ LitElement: lt });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const si = { attribute: !0, type: String, converter: yt, reflect: !1, hasChanged: Ot }, ai = (e = si, t, i) => {
  ...
  if (o === void 0 && globalThis.litPropertyMetadata.set(a, o = /* @__PURE__ */ new Map()), s === "setter" && ((e = Object.create(e)).wrapped = !0), o.set(i.name, e), s === "accessor") {
    ...
    return { set(n) {
      ...
      t.set.call(this, n), this.requestUpdate(r, d, e, !0, n);
    }, init(n) {
  ...
  if (s === "setter") {
    ...
    return function(n) {
      const d = this[r];
      t.call(this, n), this.requestUpdate(r, d, e, !0, n);
    };
  }
  throw Error("Unsupported decorator location: " + s);
};
function se(e) {
  return (t, i) => typeof i == "object" ? ai(e, t, i) : ((s, a, o) => {
...
const ri = "/local/fruity-weather-card/precip-grid.json";
function ae(e) {
  return e.nx === B && e.ny === $ && Math.abs((e.dlon ?? 0) - W) < 1e-6 && Math.abs((e.dlat ?? 0) - Z) < 1e-6;
}
async function ni(e, t) {
  try {
    const i = await fetch(`${ri}?t=${Math.floor(Date.now() / 6e4)}`);
    if (!i.ok) return;
...
async function hi(e, t) {
  const i = await ni(e, t);
  if (i) return i;
  const s = [], a = [];
  for (let A = 0; A < $; A++)
    for (let f = 0; f < B; f++)
      s.push((e + (A - ($ - 1) / 2) * Z).toFixed(4)), a.push((t + (f - (B - 1) / 2) * W).toFixed(4));
  const o = `https://api.open-meteo.com/v1/forecast?latitude=${s.join(",")}&longitude=${a.join(",")}&hourly=precipitation&forecast_hours=13&minutely_15=precipitation&forecast_minutely_15=8&timezone=UTC`, r = li(e, t);
  if (r) return r;
  const n = await fetch(o);
  if (!n.ok) throw new Error(`open-meteo ${n.status}`);
  const d = await n.json(), l = Array.isArray(d) ? d : [d];
  if (l.length !== B * $)
    throw new Error(`open-meteo returned ${l.length} of ${B * $} points`);
  const p = (A) => (/* @__PURE__ */ new Date(`${A}Z`)).getTime(), h = l[0].hourly.time.map(p), c = l[0].minutely_15.time.map(p), u = (A, f) => Array.from({ length: A }, (x, v) => {
    const S = new Float32Array(B * $);
    for (let C = 0; C < l.length; C++) S[C] = f(l[C], v) || 0;
    return S;
  }), g = {
    fetchedAt: Date.now(),
    lat0: e,
    ...
    hourly: {
      times: h,
      frames: u(h.length, (A, f) => A.hourly.precipitation[f])
    },
    quarter: {
      times: c,
      frames: u(c.length, (A, f) => A.minutely_15.precipitation[f])
    }
  };
  return di(g), g;
}
...
function li(e, t) {
  try {
    ...
    if (Date.now() - s.fetchedAt > re || Math.abs(s.lat0 - e) > 1e-6 || Math.abs(s.lon0 - t) > 1e-6 || !ae(s)) return;
    const a = (o) => o.map((r) => Float32Array.from(r));
    return {
      fetchedAt: s.fetchedAt,
      lat0: s.lat0,
...
const bt = (e, t) => (e + 180) / 360 * 2 ** t, vt = (e, t) => {
  const i = e * Math.PI / 180;
  return (1 - Math.asinh(Math.tan(i)) / Math.PI) / 2 * 2 ** t;
};
function ci(e, t, i, s, a) {
  return {
    z: i,
    originX: bt(t, i) * 256 - s / 2,
    originY: vt(e, i) * 256 - a / 2,
    width: s,
    height: a
  };
}
const pi = "Esri, HERE, Garmin, © OpenStreetMap contributors";
function ui(e, t = "dark") {
  const i = "https://services.arcgisonline.com/ArcGIS/rest/services/Canvas", s = t === "dark" ? "Dark" : "Light", a = e.z, o = 256, r = 2 ** a, n = [], d = Math.floor(e.originX / o), l = Math.floor(e.originY / o), p = Math.floor((e.originX + e.width) / o), h = Math.floor((e.originY + e.height) / o);
  for (let c = l; c <= h; c++)
    if (!(c < 0 || c >= r))
      for (let u = d; u <= p; u++) {
        const g = (u % r + r) % r;
        n.push({
          key: `${s}/${a}/${g}/${c}`,
          base: `${i}/World_${s}_Gray_Base/MapServer/tile/${a}/${c}/${g}`,
          ref: `${i}/World_${s}_Gray_Reference/MapServer/tile/${a}/${c}/${g}`,
          left: u * o - e.originX,
          top: c * o - e.originY,
          size: o
        });
...
function gi(e, t, i) {
  ...
  const a = J[s], o = J[Math.min(s + 1, J.length - 1)], r = o[0] - a[0], n = r > 0 ? Math.min(1, Math.max(0, (e - a[0]) / r)) : 0;
  t[i] = a[1] + (o[1] - a[1]) * n, t[i + 1] = a[2] + (o[2] - a[2]) * n, t[i + 2] = a[3] + (o[3] - a[3]) * n, t[i + 3] = a[4] + (o[4] - a[4]) * n;
}
const fi = J.slice(1).map(([e, t, i, s]) => `rgb(${t},${i},${s}) ${((e / 15) ** 0.45 * 100).toFixed(0)}%`).join(", ");
function mi(e, t, i, s) {
  ...
  if (!l) return;
  const p = l.createImageData(B, $);
  for (let v = 0; v < $; v++)
    for (let S = 0; S < B; S++) {
      const C = ($ - 1 - v) * B + S;
      gi(i[C], p.data, (v * B + S) * 4);
    }
  l.putImageData(p, 0, 0);
  const h = document.createElement("canvas");
  h.width = B * 6, h.height = $ * 6;
  const c = h.getContext("2d");
  if (!c) return;
  c.imageSmoothingEnabled = !0, c.imageSmoothingQuality = "high", c.drawImage(d, 0, 0, h.width, h.height);
  const u = oi(t.lat0, t.lon0), g = (bt(u.west, s.z) * 256 - s.originX) * a, A = (bt(u.east, s.z) * 256 - s.originX) * a, f = (vt(u.north, s.z) * 256 - s.originY) * a, x = (vt(u.south, s.z) * 256 - s.originY) * a;
  n.imageSmoothingEnabled = !0, n.imageSmoothingQuality = "high", n.drawImage(h, g, f, A - g, x - f);
}
function Ai(e, t, i, s) {
  for (let a = 0; a < e.length; a++) s[a] = e[a] + (t[a] - e[a]) * i;
  return s;
}
const ne = "fruity-weather-card:hourly-10d:v2", yi = "/local/fruity-weather-card/precip-hourly.json", wi = "temperature_2m,weather_code,precipitation_probability,precipitation", bi = "precipitation_probability_max", Dt = 60 * 60 * 1e3;
function vi(e) {
...
function he(e) {
  ...
  for (let i = 0; i < e.time.length; i++) {
    const s = e.time[i], a = e.temperature_2m[i];
    if (a == null) continue;
    const o = s.slice(0, 10), r = Number(s.slice(11, 13)), n = (/* @__PURE__ */ new Date(`${s}:00`)).getTime(), d = t.get(o) ?? [];
    d.push({
      hour: r,
      time: n,
      temp: a,
      condition: vi(e.weather_code[i] ?? 3),
      precipProb: e.precipitation_probability[i] ?? 0,
      precipMm: e.precipitation[i] ?? 0
    }), t.set(o, d);
  }
  return t;
}
async function _i() {
  try {
    const e = await fetch(`${yi}?t=${Math.floor(Date.now() / 6e4)}`);
    if (!e.ok) return;
    const t = await e.json();
    if (!t?.fetchedAt || !t.hourly?.time?.length || Date.now() - t.fetchedAt > Dt * 3) return;
    const i = /* @__PURE__ */ new Map(), s = t.daily?.time ?? [], a = t.daily?.precipitation_probability_max ?? [];
    for (let o = 0; o < s.length; o++) i.set(s[o], a[o] ?? 0);
    return { fetchedAt: t.fetchedAt, days: he(t.hourly), dayProb: i };
  } catch {
    return;
  }
}
function ki(e, t, i = !1) {
  if (!i && ot) return ot;
  const s = Si(e, t, i);
  return i || (ot = s, s.finally(() => {
    ot === s && (ot = void 0);
  })), s;
}
let ot;
async function Si(e, t, i = !1) {
  if (!i) {
    const A = xi();
    if (A) return A;
  }
  ...
  if (s)
    return Vt(s), s;
  const a = `https://api.open-meteo.com/v1/forecast?latitude=${e.toFixed(4)}&longitude=${t.toFixed(4)}&hourly=${wi}&daily=${bi}&forecast_days=10&timezone=auto`, o = await fetch(a);
  ...
  const d = n.length, l = (A) => A ?? new Array(d).fill(null), p = he({
    time: n,
    temperature_2m: l(r.hourly?.temperature_2m),
    weather_code: l(r.hourly?.weather_code),
    precipitation_probability: l(r.hourly?.precipitation_probability),
    precipitation: l(r.hourly?.precipitation)
  }), h = /* @__PURE__ */ new Map(), c = r.daily?.time ?? [], u = r.daily?.precipitation_probability_max ?? [];
  for (let A = 0; A < c.length; A++) h.set(c[A], u[A] ?? 0);
  const g = { fetchedAt: Date.now(), days: p, dayProb: h };
  return Vt(g), g;
}
function St(e) {
...
var Ci = Object.defineProperty, Bi = Object.getOwnPropertyDescriptor, O = (e, t, i, s) => {
  for (var a = s > 1 ? void 0 : s ? Bi(t, i) : t, o = e.length - 1, r; o >= 0; o--)
    (r = e[o]) && (a = (s ? r(t, i, a) : r(a)) || a);
  return s && a && Ci(t, i, a), a;
};
const Oi = Kt(fi), $i = 20, Mi = /* @__PURE__ */ new Set([
  "rainy",
  "pouring",
  "snowy",
  "snowy-rainy",
  ...
  cloudy: "night_cloudy",
  rainy: "night_drizzle"
}, Ri = { sunrise: "sunrise", sunset: "sunset" }, Ii = [
  ["N", 48, 13, 0],
  ["E", 83, 48, 90],
  ["S", 48, 83, 180],
  ["W", 13, 48, 270]
...
function rt(e, t) {
  return e ? t && Yt[e] ? Yt[e] : Di[e] ?? "not-available" : "not-available";
}
const Gt = {
  "clear-night": "Clear",
  cloudy: "Cloudy",
...
function Jt(e) {
  ...
  for (let i = 0; i < L.length - 1; i++) {
    ...
    if (e >= s && e <= o) {
      const n = (e - s) / (o - s);
      return `rgb(${a.map((l, p) => Math.round(l + (r[p] - l) * n)).join(",")})`;
    }
  }
  return "#ffffff";
}
...
}, k = (e) => e === void 0 ? "--" : `${Math.round(e)}`, nt = (e) => y`
...
let b = class extends lt {
  ...
  async _ensureGrid() {
    ...
    if (!(e === void 0 || t === void 0 || this._gridPending) && !(this._grid && Date.now() - this._grid.fetchedAt < re) && !(Date.now() < this._gridRetryAt)) {
      this._gridPending = !0;
      try {
        this._grid = await hi(e, t), this._gridBackoff = 0, this._gridRetryAt = 0, this._mapT = 0, this._mapFrame = 0, this._mapOpen && !window.matchMedia?.("(prefers-reduced-motion: reduce)").matches && (await this.updateComplete, this._autoPlay());
      } catch (i) {
  ...
  async _ensureHourly(e = !1) {
    ...
    if (!(t === void 0 || i === void 0 || this._hourlyPending) && !(!e && this._hourlyDays && Date.now() - this._hourlyDays.fetchedAt < Dt) && !(!e && Date.now() < this._hourlyRetryAt)) {
      this._hourlyPending = !0, this._hourlyError = !1;
      try {
        this._hourlyDays = await ki(t, i, e), this._hourlyBackoff = 0, this._hourlyRetryAt = 0;
      } catch (s) {
  ...
  _dayProb(e) {
    ...
    const i = this._hourlyDays.dayProb.get(St(new Date(t.datetime)));
    return this._printableProb(t.condition, i);
  }
  /**
  ...
  _printableProb(e, t) {
    if (t !== void 0)
      return t >= $i || e && Mi.has(e) ? t : void 0;
  }
  /**
  ...
  _hourAt(e) {
    ...
    const t = this._hourlyDays.days.get(St(e));
    if (!t) return;
    const i = new Date(e);
    return i.setMinutes(0, 0, 0), t.find((s) => s.time === i.getTime());
  }
  _openDaySheet(e) {
  ...
  async _setSheetMode(e) {
    e !== this._sheetMode && await this._pushSwap(e === "precip" ? 1 : -1, () => {
      this._sheetMode = e;
    });
  }
  /**
   ...
   */
  async _pushSwap(e, t) {
    const i = this.renderRoot.querySelector(".sheet-stage"), s = this.renderRoot.querySelector(".sheet-body");
    if (this._hourScrub = null, !i || !s || b._reducedMotion()) {
      t();
      return;
    }
    ...
    const o = Math.min(i.getBoundingClientRect().width * 0.16, 90);
    t(), await this.updateComplete;
    const r = a.animate(
      [{ transform: "translateX(0)" }, { transform: `translateX(${-e * o}px)` }],
    ...
    const n = () => a.remove();
    r.addEventListener("finish", n), r.addEventListener("cancel", n), s.animate(
      [{ transform: `translateX(${e * o}px)` }, { transform: "translateX(0)" }],
  ...
  _hoursForDay(e) {
    const t = this._daily[e];
    return !t || !this._hourlyDays ? [] : this._hourlyDays.days.get(St(new Date(t.datetime))) ?? [];
  }
  get _mapSeries() {
    const e = this._grid;
  ...
  _paintMap() {
    ...
    const s = ci(t.lat, t.lon, this._zoom, i.width, i.height), a = this._mapViewport;
    ...
    let h = r.frames[l];
    p !== l && ((!this._mapScratch || this._mapScratch.length !== h.length) && (this._mapScratch = new Float32Array(h.length)), h = Ai(r.frames[l], r.frames[p], d - l, this._mapScratch)), mi(o, this._grid, h, s);
  }
  /**
  ...
  async _reflowGrid(e, t = () => !0) {
    ...
    for (const r of o) {
      const n = a.get(r), d = r.getBoundingClientRect(), l = n.left - d.left, p = n.top - d.top;
  ...
  _override(e, t) {
    ...
    if (i) {
      ...
      if (s && s.state !== "unavailable" && s.state !== "unknown") return H(s.state);
    }
  ...
  _timeLabel(e, t = !1) {
    ...
    return y`${i}${s ? y`<span class="ap">${s}</span>` : w}`;
  }
  /**
  ...
  _sunArc() {
    ...
    if (!e || !t) return;
    const i = 864e5, s = Date.now(), a = 0.2, o = 0.8, r = 26, n = 17, d = 11, l = 100, p = (f) => f >= a && f <= o ? Math.sin(Math.PI * (f - a) / (o - a)) : f < a ? -Math.sin(Math.PI * ((a - f) / (2 * a))) : -Math.sin(Math.PI * ((f - o) / (2 * (1 - o)))), h = (f) => r - f * (f >= 0 ? n : d), c = (f, x, v) => {
      const S = [];
      for (let C = 0; C <= v; C++) {
        const U = f + (x - f) * C / v;
        S.push(`${(U * l).toFixed(2)},${h(p(U)).toFixed(2)}`);
      }
      return `M${S.join(" L")}`;
    }, u = (f) => Math.min(Math.max(f, 0), 1);
    let g;
    if (t < e) {
      const f = e.getTime() - i, x = u((s - f) / (t.getTime() - f));
      g = a + x * (o - a);
    } else {
      const f = t.getTime() - i, x = u((s - f) / (e.getTime() - f));
  ...
  _iconUrl(e) {
    ...
    return t ? `${t.replace(/\/+$/, "")}/${e}.png` : new URL((/* @__PURE__ */ Object.assign({ "../icons/clear.png": Ae, "../icons/cloudy.png": ye, "../icons/drizzle.png": we, "../icons/fog.png": be, "../icons/freezing_rain.png": ve, "../icons/haze.png": xe, "../icons/heavy_rain.png": _e, "../icons/heavy_snow.png": ke, "../icons/night_clear.png": Se, "../icons/night_cloudy.png": Ce, "../icons/night_drizzle.png": Be, "../icons/partly_cloudy.png": Oe, "../icons/rain.png": $e, "../icons/snow.png": Me, "../icons/sunrise.png": Ee, "../icons/sunset.png": De, "../icons/thunderstorm.png": Re, "../icons/windy.png": Ie }))[`../icons/${e}.png`], import.meta.url).href;
  }
  // -- render ---------------------------------------------------------------
  render() {
    ...
    ` : y`<ha-card><div class="err">Entity ${this._config.entity} not found</div></ha-card>`;
  }
  /**
  ...
  _renderHero(e) {
    const t = this._config.name ?? e.attributes.friendly_name ?? this._config.entity, i = this._override("temperature", "temperature"), s = this._daily[0], a = H(s?.temperature), o = H(s?.templow), r = Gt[e.state] ?? e.state, n = this._tap("hero"), d = this._heroScene(e.state), l = this._config, p = (u) => typeof u == "number" ? `${u}px` : u, h = [], c = (l.backgrounds_path ?? Ei).replace(/\/+$/, "");
    return d && h.push(`--fwc-hero: url("${c}/hero-${d}.jpg?v=2")`), l.hero_bleed_x !== void 0 && h.push(`--fwc-hero-bleed-x: ${p(l.hero_bleed_x)}`), l.hero_bleed_top !== void 0 && h.push(`--fwc-hero-bleed-top: ${p(l.hero_bleed_top)}`), l.hero_extend !== void 0 && h.push(`--fwc-hero-extend: ${p(l.hero_extend)}`), l.hero_radius !== void 0 && h.push(`--fwc-hero-radius: ${p(l.hero_radius)}`), y`
      <div class="hero ${d ? "has-bg" : ""}" ?tappable=${!!n}
           style=${h.join("; ")}
           @pointerdown=${this._markPointer} @click=${n}>
        <div class="loc">${t}</div>
        <div class="temp">${k(i)}<span class="deg">°</span></div>
  ...
  _renderHourly() {
    if (!this._hourly.length) return w;
    const e = this._config.hourly_hours ?? 24, t = Date.now(), i = t + e * 36e5, s = [];
    this._hourly.forEach((h, c) => {
      const u = new Date(h.datetime);
      if (u.getTime() > i) return;
      const g = this._hourAt(u), A = g?.condition ?? h.condition ?? "";
      s.push({
        kind: "hour",
        time: u,
        label: c === 0 ? y`Now` : this._timeLabel(u),
        condition: A,
        temp: H(h.temperature),
        prob: this._printableProb(A, g?.precipProb)
      });
    });
    ...
    const r = this._override("wind_gust"), n = this._overrideUnit("wind_gust", "wind_speed_unit") ?? "km/h", d = Gt[this._weather?.state ?? ""] ?? "", l = d ? `${d} conditions expected for the rest of the day.` + (r !== void 0 ? ` Wind gusts are up to ${k(r)} ${n}.` : "") : "", p = this._tap("hourly");
    return y`
      <div class="panel strip" ?tappable=${!!p}
           @pointerdown=${this._markPointer} @click=${p}>
        ${l ? y`<div class="strip-summary">${l}</div>` : w}
        <div class="row">
          ${s.map((h) => h.kind === "sun" ? y`
                <div class="cell">
                  <div class="cell-label">${h.label}</div>
                  <img class="cell-icon" src=${this._iconUrl(Ri[h.event])} alt=${h.event} />
                  <div class="cell-prob"></div>
                  <div class="cell-val sun">${h.event === "sunrise" ? "Sunrise" : "Sunset"}</div>
                </div>` : y`
                <div class="cell">
                  <div class="cell-label">${h.label}</div>
                  <img class="cell-icon" src=${this._iconUrl(rt(h.condition, this._nightAt(h.time)))} alt=${h.condition} />
                  <div class="cell-prob">${h.prob === void 0 ? w : y`${Math.round(h.prob)}%`}</div>
                  <div class="cell-val">${k(h.temp)}°</div>
                </div>`)}
        </div>
      </div>
    `;
  ...
  _renderDaily() {
    ...
    const t = e.map((l) => H(l.templow)).filter((l) => l !== void 0), i = e.map((l) => H(l.temperature)).filter((l) => l !== void 0), s = Math.min(...t, ...i), a = Math.max(...t, ...i), o = Math.max(a - s, 1), r = this._override("temperature", "temperature"), n = this.hass?.locale?.language ?? navigator.language, d = this._tap("daily");
    return y`
      <div class="panel daily" ?tappable=${!!d}
           @pointerdown=${this._markPointer} @click=${d}>
        <div class="panel-head">${e.length}-DAY FORECAST</div>
        ${e.map((l, p) => {
      const h = H(l.templow), c = H(l.temperature), u = new Date(l.datetime), g = p === 0 ? "Today" : u.toLocaleDateString(n, { weekday: "short" }), A = h === void 0 ? 0 : (h - s) / o * 100, f = h === void 0 || c === void 0 ? 0 : (c - h) / o * 100, x = p === 0 && r !== void 0 ? (r - s) / o * 100 : void 0;
      return y`
            <div class="drow" tappable
                 @pointerdown=${this._markPointer}
                 @click=${(v) => {
        v.stopPropagation(), !this._movedSincePointer(v) && (this._sheetDay === p ? this._closeDaySheet() : this._openDaySheet(p));
      }}>
              <div class="dday">${g}</div>
              <div class="dcond">
                <img class="dicon" src=${this._iconUrl(rt(l.condition, p === 0 && this._isNight))} alt=${l.condition ?? ""} />
                ${(() => {
        const v = this._dayProb(p);
        return v === void 0 ? w : y`<span class="dprob">${Math.round(v)}%</span>`;
      })()}
              </div>
              <div class="dlo">${k(h)}°</div>
              <div class="track">
                <div class="bar" style=${`left:${A}%;width:${f}%;background:linear-gradient(90deg, ${Jt(h ?? s)}, ${Jt(c ?? a)})`}></div>
                ${x !== void 0 ? y`<div class="dot" style=${`left:${Math.min(Math.max(x, 0), 100)}%`}></div>` : w}
              </div>
      ...
      <div class="daycard">
        <svg class="sheet-arrow" viewBox="0 0 26 36" aria-hidden="true">
          ...
          <button class="snav prev" ?disabled=${e === 0}
            ...
            ${E`<svg viewBox="0 0 24 24" width="18" height="18" aria-hidden="true">
  ...
  _renderSheetBody(e, t, i) {
    if (this._hourlyPending && !e.length)
      return y`<div class="sheet-note">Loading hourly forecast…</div>`;
    ...
    const s = this._sheetMode === "precip", a = s ? "%" : "°", o = e.map((m) => s ? m.precipProb : m.temp), r = Math.max(...o), n = Math.min(...o), d = e[o.indexOf(r)], l = e[o.indexOf(n)];
    let p, h;
    const c = [];
    if (s)
      p = 0, h = 100, c.push(100, 50, 0);
    else {
      p = Math.floor(n / 5) * 5, h = Math.ceil(r / 5) * 5;
      const _ = 4, D = Math.max(h - p, 5);
      let R = 5;
      for (; Math.floor(D / R) + 1 > _; ) R += 5;
      for (let z = h; z >= p - 1e-3; z -= R) c.push(z);
    }
    const u = Math.max(h - p, s ? 1 : 5), g = e.length, A = (m) => g > 1 ? m / (g - 1) * 100 : 50, f = (m) => (h - m) / u * 100, x = Date.now();
    let v = null;
    ...
    const S = (m) => v !== null && m < v, C = o.map((m, _) => `${A(_)},${f(m)}`).join(" ");
    let U = "", tt = C, et = "", X = `0,100 ${C} 100,100`;
    if (v !== null) {
      const m = Math.floor(v), _ = v - m, D = A(v), R = f(o[m] + (o[m + 1] - o[m]) * _), z = o.slice(0, m + 1).map((it, st) => `${A(st)},${f(it)}`).join(" "), V = o.slice(m + 1).map((it, st) => `${A(m + 1 + st)},${f(it)}`).join(" ");
    ...
    return y`
        ...
        ${T ? y`
              <div class="sheet-hilo scrubbing">
                <img class="sheet-cond"
                     ...
                     alt=${T.condition} />
                <span class="scrub-temp ${s ? "precip" : ""}">${k(ft)}${a}</span>
              </div>
            ` : s ? y`
              ...
              ` : y`
                <div class="sheet-hilo">
                  ...
                  <img class="sheet-cond"
                       src=${this._iconUrl(rt(i.condition, !1))} alt="" />
                </div>
              `}
        <div class="sheet-unit">
          ${T ? this._clockLabel(new Date(T.time)) : s ? "Chance of precipitation" : t === "°F" ? "Fahrenheit (°F)" : "Celsius (°C)"}
        </div>
      </div>

      <div class="sheet-glyphs">
        ${e.map((m, _) => _ % gt === 0 ? y`<img class="sglyph ${_ === 0 ? "first" : _ === g - 1 ? "last" : ""} ${S(_) ? "past" : ""}"
                      style=${`left:${A(_)}%`}
      ...
      this._hourScrub = null;
          ...
          ${v !== null ? y`<div class="now-line" style=${`left:${A(v)}%`}></div>` : w}
          ...
          <svg class="scurve ${s ? "precip" : ""}" viewBox="0 0 100 100" preserveAspectRatio="none">
            <defs>
            ...
            ${et ? E`<polygon points=${et} fill="url(#sfillpast)" />` : w}
            <polygon points=${X} fill="url(#sfill)" />
            ${U ? E`<polyline class="past" points=${U} vector-effect="non-scaling-stroke" />` : w}
            <polyline points=${tt} vector-effect="non-scaling-stroke" />
          </svg>
          ${s ? w : (() => {
      const m = f(r), _ = f(n), D = e.indexOf(d), R = e.indexOf(l);
      return y`
              <div class="smark hi ${m < 22 ? "flip" : ""} ${S(D) ? "past" : ""}"
                   style=${`left:${A(D)}%; top:${m}%`}>
                <span>H</span>
              </div>
              <div class="smark lo ${_ > 78 ? "flip" : ""} ${S(R) ? "past" : ""}"
                   style=${`left:${A(R)}%; top:${_}%`}>
                <span>L</span>
              </div>
            `;
    })()}
          ${T ? y`
                <div class="scrub-line ${s ? "precip" : ""}" style=${`left:${A(this._hourScrub)}%`}></div>
                <div class="scrub-dot" style=${`left:${A(this._hourScrub)}%; top:${f(ft)}%`}></div>
              ` : w}
        </div>
        <div class="sheet-yaxis">
          ${c.map((m) => y`<span style=${`top:${f(m)}%`}>${k(m)}${a}</span>`)}
        </div>
      </div>

      <div class="sheet-xaxis">
        ${e.map((m, _) => m.hour % 6 === 0 && m.hour !== 0 ? y`<span class="${_ === g - 1 ? "last" : ""} ${S(_) ? "past" : ""}"
                       style=${`left:${A(_)}%`}>${this._hourLabel(m.hour)}</span>` : w)}
      </div>
    `;
  }
  /**
  ...
  _positionReadout() {
    ...
    e.style.transform = "translateX(0)";
    const o = e.getBoundingClientRect(), r = t.getBoundingClientRect(), n = i.getBoundingClientRect(), d = getComputedStyle(i), l = parseFloat(d.paddingLeft) || 0, p = parseFloat(d.paddingRight) || 0, h = r.left + a * r.width, c = n.left + l - o.left, u = n.right - p - o.width - o.left, g = Math.min(Math.max(h - o.width / 2 - o.left, c), Math.max(u, c));
  ...
  _hourLabel(e) {
    ...
    return y`${o.trim()}${r ? y`<span class="ap">${r}</span>` : w}`;
  }
  /**
  ...
  _renderSunTile(e, t, i) {
    const s = e ? t : i, a = e ? i : t, o = s ? this._fmtTimeParts(s) : { time: "--", suffix: "" }, r = a ? this._fmtTimeParts(a) : { time: "--", suffix: "" }, n = this._sunArc(), d = this._tap("sun");
    return y`
  ...
  _renderTiles() {
    const { rising: e, setting: t } = this._sunTimes(), i = this._override("feels_like", "apparent_temperature"), s = this._override("temperature", "temperature"), a = this._override("humidity", "humidity"), o = this._override("dew_point", "dew_point"), r = this._override("wind_speed", "wind_speed"), n = this._override("wind_gust"), d = this._override("wind_bearing", "wind_bearing"), l = this._override("precipitation_today"), p = this._overrideUnit("wind_speed", "wind_speed_unit") ?? "km/h", h = this._overrideUnit("wind_gust") ?? p, c = e && t ? e < t : !0, u = i === void 0 || s === void 0 ? "" : Math.abs(i - s) < 0.5 ? "Similar to the actual temperature." : i > s ? "It feels warmer than the actual temperature." : "It feels cooler than the actual temperature.", g = this._daily.find((C) => (H(C.precipitation) ?? 0) > 0), A = this.hass?.locale?.language ?? navigator.language, f = g ? H(g.precipitation) ?? 0 : void 0, x = f === void 0 ? "" : `${f < 1 ? "<1" : Math.round(f)} mm`, v = g ? new Date(g.datetime).toDateString() === (/* @__PURE__ */ new Date()).toDateString() : !1, S = x ? v ? `${x} more expected today.` : `Next expected is ${x} ${new Date(g.datetime).toLocaleDateString(A, { weekday: "short" })}.` : "None expected in the next 10 days.";
    return y`
        ${this._renderSunTile(c, e, t)}
        ${this._renderWindTile(r, p, n, h, d)}
        ...
        <div class="tile" ?tappable=${!!this._tap("precipitation")}
          ...
          <div class="tile-value">${l === void 0 ? "--" : k(l)} mm</div>
        ...
        <div class="tile" ?tappable=${!!this._tap("humidity")}
          ...
          <div class="tile-note">
            ${o !== void 0 ? y`The dew point is ${k(o)}° right now.` : w}
          </div>
        </div>

        ${this._config?.map ? this._renderMapTile() : w}
    `;
  }
  /**
  ...
  _renderMapTile() {
    ...
    r && t && (a = `${(bt(r.lon, t.z) * 256 - t.originX) / t.width * 100}%`, o = `${(vt(r.lat, t.z) * 256 - t.originY) / t.height * 100}%`);
    const n = e ? this._mapSeries : void 0, d = n ? Math.min(this._mapFrame, n.frames.length - 1) : 0, l = n ? new Date(n.times[d]) : void 0, p = this._config?.map_style ?? "dark", h = t ? ui(t, p) : [];
    return y`
      ...
      c.stopPropagation(), this._toggleMap();
              ...
              ${E`<svg viewBox="0 0 24 24" width="17" height="17" aria-hidden="true">
                <path d="M6 6 L18 18 M18 6 L6 18" />
              </svg>`}
            </button>
          ` : w}

          ${this._mapOpen && !n?.frames.length ? y`
          ...
          ${this._mapOpen && n?.frames.length && l ? y`
      ...
      return !g && u % 2 !== 0 ? w : y`<span>
                    ${u === 0 ? "Now" : this._timeLabel(new Date(c), g)}
                  </span>`;
    })}
              </div>
            </div>` : w}

          ${!e && !this._mapOpen ? y`<div class="map-note">
            ${this._gridRetryAt ? "No forecast" : "Loading…"}
          </div>` : w}
          ${this._mapOpen ? y`<div class="map-credit">${pi}</div>` : w}
        </div>
      </div>
    `;
  }
  ...
  _renderWindTile(e, t, i, s, a) {
    ...
    for (let I = 0; I < 72; I++) {
      const P = I * 5;
      if ([0, 90, 180, 270].some((me) => Math.abs(((P - me) % 360 + 540) % 360 - 180) > 168)) continue;
      const mt = r(P), [pe, ue] = n(31, mt), [ge, fe] = n(39, mt);
      d += `M${pe.toFixed(2)},${ue.toFixed(2)}L${ge.toFixed(2)},${fe.toFixed(2)}`;
    }
    const l = a !== void 0, p = l ? a + 180 : 0, h = r(p), c = r(p + 180), u = 38, [g, A] = n(u, c), [f, x] = n(u - 3, c), [v, S] = n(24.5, c), [C, U] = n(22.5, h), [tt, et] = n(30, h), X = 1.32, gt = (u + 2 + 30) / 2, T = (u + 2 - 30) / 2 * X, [ft, m] = n(gt + T, h), [_, D] = n(gt - T, h), R = -Math.sin(h), z = Math.cos(h), V = 3.4 * X, it = _ + R * V, st = D + z * V, le = _ - R * V, de = D - z * V, ce = (I) => {
      const P = Math.abs(((p - I) % 360 + 360) % 360);
      ...
      <div class="tile wide" ?tappable=${!!Rt}
        ...
        <div class="wind-body">
          <div class="wind-rows">
            ...
            <div class="wrow"><span>Gusts</span><b>${k(i)} ${s}</b></div>
          </div>
          <svg class="dial" viewBox="0 0 96 96" aria-hidden="true">
            ...
            ${l ? E`
              ...
              <circle class="dial-tail" cx=${g.toFixed(2)} cy=${A.toFixed(2)}
                      r=${(3.2 * X).toFixed(2)}></circle>
              <polygon class="dial-head" points=${`${ft.toFixed(2)},${m.toFixed(2)} ${it.toFixed(2)},${st.toFixed(2)} ${le.toFixed(2)},${de.toFixed(2)}`}></polygon>` : w}
...
b.styles = Te`
    ...
    *::after {
    ...
    .map-legend-bar {
      ...
      background: linear-gradient(to top, ${Oi});
    }
    .map-legend-labels {
      display: flex;
      flex-direction: column;
