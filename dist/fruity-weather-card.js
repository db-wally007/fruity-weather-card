 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: je, defineProperty: Qe, getOwnPropertyDescriptor: Le, getOwnPropertyNames: Ne, getOwnPropertySymbols: Fe, getPrototypeOf: Xe } = Object, _t = globalThis, Ut = _t.trustedTypes, Ve = Ut ? Ut.emptyScript : "", Ye = _t.reactiveElementPolyfillSupport, ht = (e, t) => e, wt = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? Ve : null;
      break;
  ...
  return s;
} }, Mt = (e, t) => !je(e, t), zt = { attribute: !0, type: String, converter: wt, reflect: !1, useDefault: !1, hasChanged: Mt };
...
let G = class extends HTMLElement {
  ...
  static createProperty(t, s = zt) {
    if (s.state && (s.attribute = !1), this._$Ei(), this.prototype.hasOwnProperty(t) && ((s = Object.create(s)).wrapped = !0), this.elementProperties.set(t, s), !s.noAccessor) {
      ...
      a !== void 0 && Qe(this.prototype, t, a);
    }
  }
  static getPropertyDescriptor(t, s, i) {
    const { get: a, set: o } = Le(this.prototype, t) ?? { get() {
      return this[s];
    }, set(r) {
      this[s] = r;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(ht("properties"))) {
      const s = this.properties, i = [...Ne(s), ...Fe(s)];
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      ...
      for (const a of i) s.unshift(Ht(a));
  ...
  requestUpdate(t, s, i, a = !1, o) {
    if (t !== void 0) {
      ...
      if (a === !1 && (o = this[t]), i ??= r.getPropertyOptions(t), !((i.hasChanged ?? Mt)(o, s) || i.useDefault && i.reflect && o === this._$Ej?.get(t) && !this.hasAttribute(r._$Eu(t, i)))) return;
      this.C(t, s, i);
    }
...
G.elementStyles = [], G.shadowRootOptions = { mode: "open" }, G[ht("elementProperties")] = /* @__PURE__ */ new Map(), G[ht("finalized")] = /* @__PURE__ */ new Map(), Ye?.({ ReactiveElement: G }), (_t.reactiveElementVersions ??= []).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
class Ke {
  ...
  u(t) {
    ...
    for (; l !== void 0; ) {
      if (r === l.index) {
        let p;
        l.type === 2 ? p = new ut(o, o.nextSibling, this, t) : l.type === 1 ? p = new l.ctor(o, l.name, l.strings, this, t) : l.type === 6 && (p = new ei(o, this, t)), this._$AV.push(p), l = i[++n];
      }
...
class ut {
  ...
  constructor(t, s, i, a) {
    this.type = 2, this._$AH = A, this._$AN = void 0, this._$AA = t, this._$AB = s, this._$AM = i, this.options = a, this._$Cv = a?.isConnected ?? !0;
  }
  get parentNode() {
  ...
  $(t) {
    ...
    if (this._$AH?._$AD === a) this._$AH.p(s);
      ...
      const o = new Ke(a, this), r = o.u(this.options);
      o.p(s), this.T(r), this._$AH = o;
    }
  }
  _$AC(t) {
    let s = Vt.get(t.strings);
    return s === void 0 && Vt.set(t.strings, s = new pt(t)), s;
  }
  k(t) {
...
class kt {
  ...
  constructor(t, s, i, a, o) {
    this.type = 1, this._$AH = A, this._$AN = void 0, this.element = t, this.name = s, this._$AM = a, this.options = o, i.length > 2 || i[0] !== "" || i[1] !== "" ? (this._$AH = Array(i.length - 1).fill(new String()), this.strings = i) : this._$AH = A;
  }
  _$AI(t, s = this, i, a) {
...
class ti extends kt {
  ...
  _$AI(t, s = this) {
    if ((t = K(this, t, s, 0) ?? A) === q) return;
    const i = this._$AH, a = t === A && i !== A || t.capture !== i.capture || t.once !== i.once || t.passive !== i.passive, o = t !== A && (i === A || a);
...
const ii = Bt.litHtmlPolyfillSupport;
ii?.(pt, ut), (Bt.litHtmlVersions ??= []).push("3.3.3");
const si = (e, t, s) => {
...
const ai = Et.litElementPolyfillSupport;
ai?.({ LitElement: lt });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ri = { attribute: !0, type: String, converter: wt, reflect: !1, hasChanged: Mt }, ni = (e = ri, t, s) => {
...
function ae(e) {
  return (t, s) => typeof s == "object" ? ni(e, t, s) : ((i, a, o) => {
...
const O = 13, B = 11, W = 0.48, Z = 0.375;
function hi(e, t) {
  return {
    north: e + (B - 1) / 2 * Z,
    south: e - (B - 1) / 2 * Z,
...
const li = "/local/fruity-weather-card/precip-grid.json";
function oe(e) {
...
async function ci(e, t) {
  ...
  for (let w = 0; w < B; w++)
    for (let f = 0; f < O; f++)
      i.push((e + (w - (B - 1) / 2) * Z).toFixed(4)), a.push((t + (f - (O - 1) / 2) * W).toFixed(4));
  const o = `https://api.open-meteo.com/v1/forecast?latitude=${i.join(",")}&longitude=${a.join(",")}&hourly=precipitation&forecast_hours=13&minutely_15=precipitation&forecast_minutely_15=8&timezone=UTC`, r = pi(e, t);
  if (r) return r;
  ...
  const d = (w) => (/* @__PURE__ */ new Date(`${w}Z`)).getTime(), c = p[0].hourly.time.map(d), h = p[0].minutely_15.time.map(d), u = (w, f) => Array.from({ length: w }, (v, x) => {
    ...
    quarter: {
      times: h,
      frames: u(h.length, (w, f) => w.minutely_15.precipitation[f])
    }
  };
  return ui(g), g;
}
const re = "fruity-weather-card:precip-grid:v3", ne = 30 * 6e4;
function pi(e, t) {
  try {
    const s = localStorage.getItem(re);
    if (!s) return;
    const i = JSON.parse(s);
    if (Date.now() - i.fetchedAt > ne || Math.abs(i.lat0 - e) > 1e-6 || Math.abs(i.lon0 - t) > 1e-6 || !oe(i)) return;
    const a = (o) => o.map((r) => Float32Array.from(r));
    return {
      fetchedAt: i.fetchedAt,
      lat0: i.lat0,
  ...
  for (let h = p; h <= c; h++)
    if (!(h < 0 || h >= r))
      for (let u = l; u <= d; u++) {
        ...
        n.push({
          key: `${i}/${a}/${g}/${h}`,
          base: `${s}/World_${i}_Gray_Base/MapServer/tile/${a}/${h}/${g}`,
          ref: `${s}/World_${i}_Gray_Reference/MapServer/tile/${a}/${h}/${g}`,
          left: u * o - e.originX,
          top: h * o - e.originY,
          size: o
        });
...
const yi = J.slice(1).map(([e, t, s, i]) => `rgb(${t},${s},${i}) ${((e / 15) ** 0.45 * 100).toFixed(0)}%`).join(", ");
function wi(e, t, s, i) {
...
function Si() {
  try {
    ...
    return !t?.fetchedAt || Date.now() - t.fetchedAt > Dt ? void 0 : {
      ...
      dayStat: new Map(Object.entries(t.dayStat ?? {})),
      current: t.current
    };
  } catch {
    return;
  ...
  try {
    localStorage.setItem(
      ...
      JSON.stringify({
        ...
        dayStat: Object.fromEntries(e.dayStat),
        current: e.current
      })
    );
  } catch {
...
function le(e) {
  if (!e || e.temperature_2m == null) return;
  const t = (s) => s ?? void 0;
  return {
    temp: t(e.temperature_2m),
    apparentTemp: t(e.apparent_temperature),
    humidity: t(e.relative_humidity_2m),
    windSpeed: t(e.wind_speed_10m),
    windGust: t(e.wind_gusts_10m),
    windBearing: t(e.wind_direction_10m),
...
function ce(e) {
  ...
  for (let s = 0; s < e.time.length; s++) {
    ...
    l.push({
      ...
      time: n,
      temp: a,
      condition: Rt(e.weather_code[s] ?? 3),
...
}, S = (e) => e === void 0 ? "--" : `${Math.round(e)}`, nt = (e) => y`
...
let b = class extends lt {
  constructor() {
    super(...arguments), this._hourly = [], this._daily = [], this._mapOpen = !1, this._mapFrame = 0, this._mapPlaying = !1, this._sheetDay = null, this._hourScrub = null, this._entityDaily = [], this._entityHourly = [], this._hourlyError = !1, this._sheetMode = "temp", this._hourlyPending = !1, this._hourlyRetryAt = 0, this._hourlyBackoff = 0, this._mapRange = "12h", this._mapSeen = !1, this._mapT = 0, this._mapLast = 0, this._gridPending = !1, this._gridRetryAt = 0, this._gridBackoff = 0, this._outsideTap = (e) => {
  ...
  updated(e) {
    super.updated(e), (e.has("hass") || e.has("_config")) && this.hass && this._config && (this._subscribedTo !== this._config.entity && this._subscribe(), this._config.map && this._watchMapVisible()), this._config?.map && (this._paintMap(), this._syncMapBar(), this._watchMapSize()), (this._wantsOpenMeteo || this._daily.length) && this._ensureHourly(), this._sheetDay !== null && (this._positionArrow(), this._positionReadout());
  }
  /* ------------------------------------------------ precipitation map ---- */
  /**
   ...
   */
  _applyOpenMeteoForecast() {
    const e = this._hourlyDays;
    if (!e) return;
    const t = [];
    for (const [a, o] of [...e.dayStat.entries()].sort())
      t.push({
        datetime: `${a}T00:00:00`,
        condition: o.condition,
        temperature: o.hi,
        templow: o.lo,
        precipitation: o.precipMm,
        precipitation_probability: e.dayProb.get(a)
      });
    t.length && (this._daily = t);
    const s = Date.now() - 36e5, i = [];
    for (const [, a] of [...e.days.entries()].sort())
      for (const o of a)
        o.time < s || i.push({
          datetime: new Date(o.time).toISOString(),
          condition: o.condition,
          temperature: o.temp,
          precipitation: o.precipMm,
          precipitation_probability: o.precipProb
        });
    i.length && (this._hourly = i);
  }
  _dayProb(e) {
  ...
  async _pushSwap(e, t, s) {
    ...
    a.querySelectorAll(":scope > .ghost").forEach((p) => p.remove());
  ...
  _paintMap() {
    ...
    const i = gi(t.lat, t.lon, this._zoom, s.width, s.height), a = this._mapViewport;
  ...
  async _subscribe() {
    ...
    this._unsubHourly = await t("hourly", (s) => {
      this._entityHourly = s, this._wantsOpenMeteo || (this._hourly = s);
    }), this._unsubDaily = await t("daily", (s) => {
      this._entityDaily = s, this._wantsOpenMeteo || (this._daily = s);
    });
  }
  // -- data accessors -------------------------------------------------------
  get _weather() {
  ...
  _override(e, t) {
    ...
    if (this._allOpenMeteo) {
      const i = this._hourlyDays.current;
      if (i) {
        const a = {
          temperature: i.temp,
          feels_like: i.apparentTemp,
          humidity: i.humidity,
          wind_speed: i.windSpeed,
          wind_gust: i.windGust,
          wind_bearing: i.windBearing
        };
  ...
  get _currentCondition() {
    if (this._allOpenMeteo) {
      const e = this._hourlyDays.current;
      if (e) return e.condition;
    }
  ...
  _timeLabel(e, t = !1) {
    ...
    return y`${s}${i ? y`<span class="ap">${i}</span>` : A}`;
  }
  /**
  ...
  _sunArc() {
    ...
    let g;
    if (t < e) {
      const f = e.getTime() - s, v = u((i - f) / (t.getTime() - f));
      g = a + v * (o - a);
    } else {
  ...
  _iconUrl(e) {
    ...
    return t ? `${t.replace(/\/+$/, "")}/${e}.png` : new URL((/* @__PURE__ */ Object.assign({ "../icons/clear.png": be, "../icons/cloudy.png": ve, "../icons/drizzle.png": xe, "../icons/fog.png": _e, "../icons/freezing_rain.png": ke, "../icons/haze.png": Se, "../icons/heavy_rain.png": Ce, "../icons/heavy_snow.png": Oe, "../icons/night_clear.png": Me, "../icons/night_cloudy.png": Be, "../icons/night_drizzle.png": $e, "../icons/partly_cloudy.png": Ee, "../icons/rain.png": De, "../icons/snow.png": Re, "../icons/sunrise.png": Ie, "../icons/sunset.png": Te, "../icons/thunderstorm.png": Pe, "../icons/windy.png": He }))[`../icons/${e}.png`], import.meta.url).href;
  }
  // -- render ---------------------------------------------------------------
  render() {
  ...
  _renderHero(e) {
    ...
    return p && h.push(`--fwc-hero: url("${u}/hero-${p}.jpg?v=2")`), d.hero_bleed_x !== void 0 && h.push(`--fwc-hero-bleed-x: ${c(d.hero_bleed_x)}`), d.hero_bleed_top !== void 0 && h.push(`--fwc-hero-bleed-top: ${c(d.hero_bleed_top)}`), d.hero_extend !== void 0 && h.push(`--fwc-hero-extend: ${c(d.hero_extend)}`), d.hero_radius !== void 0 && h.push(`--fwc-hero-radius: ${c(d.hero_radius)}`), y`
      <div class="hero ${p ? "has-bg" : ""}" ?tappable=${!!l}
        ...
        <div class="loc">${t}</div>
        <div class="temp">${S(s)}<span class="deg">°</span></div>
  ...
  _renderHourly() {
    if (!this._hourly.length) return A;
    const e = this._config.hourly_hours ?? 24, t = Date.now(), s = t + e * 36e5, i = [];
    this._hourly.forEach((u, g) => {
      const w = new Date(u.datetime);
      if (w.getTime() > s) return;
      const f = this._hourAt(w), v = f?.condition ?? u.condition ?? "";
      i.push({
        kind: "hour",
        time: w,
        label: g === 0 ? y`Now` : this._timeLabel(w),
        condition: v,
        temp: H(u.temperature),
        prob: this._printableProb(v, f?.precipProb)
      });
    });
    ...
    return y`
      <div class="panel strip" ?tappable=${!!h}
           @pointerdown=${this._markPointer} @click=${h}>
        ${p ? y`<div class="strip-summary">${p}</div>` : A}
        <div class="row">
          ${i.map((u) => u.kind === "sun" ? y`
                ...
                <div class="cell">
                  <div class="cell-label">${u.label}</div>
                  <img class="cell-icon" src=${this._iconUrl(rt(u.condition, this._nightAt(u.time)))} alt=${u.condition} />
                  <div class="cell-prob">${u.prob === void 0 ? A : y`${Math.round(u.prob)}%`}</div>
                  <div class="cell-val">${S(u.temp)}°</div>
                </div>`)}
        </div>
      </div>
    `;
    ...
    return y`
      ...
      return y`
        ...
        return _ === void 0 ? A : y`<span class="dprob">${Math.round(_)}%</span>`;
              ...
              <div class="track">
                <div class="bar" style=${`left:${f}%;width:${v}%;background:linear-gradient(90deg, ${qt(h ?? a)}, ${qt(u ?? o)})`}></div>
                ${x !== void 0 ? y`<div class="dot" style=${`left:${Math.min(Math.max(x, 0), 100)}%`}></div>` : A}
              </div>
              <div class="dhi">${S(u)}°</div>
            </div>
          `;
    })}
      </div>
  ...
  _renderSheetBody(e, t, s) {
    ...
    if (g > 1 && v > e[0].time && v < e[g - 1].time) {
      for (let m = 0; m < g - 1; m++)
        if (v < e[m + 1].time) {
          x = m + (v - e[m].time) / (e[m + 1].time - e[m].time);
          break;
        }
    }
    const _ = (m) => x !== null && m < x, C = o.map((m, k) => `${w(k)},${f(m)}`).join(" ");
    let U = "", tt = C, et = "", X = `0,100 ${C} 100,100`;
    if (x !== null) {
      const m = Math.floor(x), k = x - m, D = w(x), R = f(o[m] + (o[m + 1] - o[m]) * k), z = o.slice(0, m + 1).map((it, st) => `${w(st)},${f(it)}`).join(" "), V = o.slice(m + 1).map((it, st) => `${w(m + 1 + st)},${f(it)}`).join(" ");
    ...
    return y`
        ...
        ${T ? y`
              <div class="sheet-hilo scrubbing">
                <img class="sheet-cond"
                     ...
                     alt=${T.condition} />
                <span class="scrub-temp ${i ? "precip" : ""}">${S(ft)}${a}</span>
              </div>
            ` : i ? y`
                <div class="sheet-hilo">
                  <span class="sheet-hi precip">${S(r)}%</span>
                </div>
              ` : y`
                <div class="sheet-hilo">
                  <span class="sheet-hi">${S(r)}°</span><span class="sheet-lo">${S(n)}°</span>
                  <img class="sheet-cond"
      ...
      <div class="sheet-glyphs">
        ${e.map((m, k) => k % gt === 0 ? y`<img class="sglyph ${k === 0 ? "first" : k === g - 1 ? "last" : ""} ${_(k) ? "past" : ""}"
                      style=${`left:${w(k)}%`}
      ...
      this._hourScrub = null;
          ...
          ${x !== null ? y`<div class="now-line" style=${`left:${w(x)}%`}></div>` : A}
          ...
          <svg class="scurve ${i ? "precip" : ""}" viewBox="0 0 100 100" preserveAspectRatio="none">
            ...
            ${et ? E`<polygon points=${et} fill="url(#sfillpast)" />` : A}
            <polygon points=${X} fill="url(#sfill)" />
            ${U ? E`<polyline class="past" points=${U} vector-effect="non-scaling-stroke" />` : A}
            <polyline points=${tt} vector-effect="non-scaling-stroke" />
          </svg>
          ${i ? A : (() => {
      const m = f(r), k = f(n), D = e.indexOf(l), R = e.indexOf(p);
      return y`
              <div class="smark hi ${m < 22 ? "flip" : ""} ${_(D) ? "past" : ""}"
                   style=${`left:${w(D)}%; top:${m}%`}>
                <span>H</span>
              </div>
              <div class="smark lo ${k > 78 ? "flip" : ""} ${_(R) ? "past" : ""}"
                   style=${`left:${w(R)}%; top:${k}%`}>
                <span>L</span>
              </div>
            `;
    })()}
        ...
        <div class="sheet-yaxis">
          ${h.map((m) => y`<span style=${`top:${f(m)}%`}>${S(m)}${a}</span>`)}
        </div>
      </div>

      <div class="sheet-xaxis">
        ${e.map((m, k) => m.hour % 6 === 0 && m.hour !== 0 ? y`<span class="${k === g - 1 ? "last" : ""} ${_(k) ? "past" : ""}"
                       style=${`left:${w(k)}%`}>${this._hourLabel(m.hour)}</span>` : A)}
      </div>
    `;
  }
  /**
  ...
  _hourLabel(e) {
    ...
    return y`${o.trim()}${r ? y`<span class="ap">${r}</span>` : A}`;
  }
  /**
  ...
  _renderTiles() {
    ...
    return y`
        ...
        <div class="tile" ?tappable=${!!this._tap("precipitation")}
          ...
          <div class="tile-value">${p === void 0 ? "--" : S(p)} mm</div>
          <div class="tile-sub">Today So Far</div>
          <div class="tile-note">${_}</div>
        </div>
        ...
        <div class="tile" ?tappable=${!!this._tap("humidity")}
          ...
          <div class="tile-note">
            ${o !== void 0 ? y`The dew point is ${S(o)}° right now.` : A}
          </div>
        </div>

        ${this._config?.map ? this._renderMapTile() : A}
    `;
  }
  /**
  ...
  _renderMapTile() {
    ...
    return y`
      ...
      this._mapOpen || this._toggleMap();
        ...
        <div class="map-frame">
          ...
          <div class="map-pin" style=${`left:${a};top:${o}`}>
            <div class="map-badge">${S(s)}°</div>
            <div class="map-dot"></div>
            <div class="map-here">My Location</div>
          </div>

          ${this._mapOpen ? y`
            <div class="map-legend" @click=${(h) => h.stopPropagation()}>
            ...
            <div class="map-zoom" @click=${(h) => h.stopPropagation()}>
            ...
            <button class="map-close" title="Close"
                    @click=${(h) => {
      h.stopPropagation(), this._toggleMap();
    }}>
          ...
          ${this._mapOpen && !n?.frames.length ? y`
            <div class="map-bar no-data" @click=${(h) => h.stopPropagation()}>
          ...
          ${this._mapOpen && n?.frames.length && p ? y`
            <div class="map-bar" @click=${(h) => h.stopPropagation()}>
      ...
      return !g && u % 2 !== 0 ? A : y`<span>
                    ${u === 0 ? "Now" : this._timeLabel(new Date(h), g)}
                  </span>`;
    })}
              </div>
            </div>` : A}
          ...
          ${this._mapOpen ? y`<div class="map-credit">${fi}</div>` : A}
        </div>
      </div>
    `;
  }
  ...
  _renderWindTile(e, t, s, i, a) {
    ...
    for (let I = 0; I < 72; I++) {
      const P = I * 5;
      if ([0, 90, 180, 270].some((we) => Math.abs(((P - we) % 360 + 540) % 360 - 180) > 168)) continue;
    ...
    return y`
      <div class="tile wide" ?tappable=${!!It}
           @pointerdown=${this._markPointer} @click=${It}>
        <div class="tile-head">${Y.wind} WIND</div>
        <div class="wind-body">
          <div class="wind-rows">
            <div class="wrow"><span>Wind</span><b>${S(e)} ${t}</b></div>
            <div class="wrow"><span>Gusts</span><b>${S(s)} ${i}</b></div>
          </div>
          <svg class="dial" viewBox="0 0 96 96" aria-hidden="true">
            ...
            -->
            ${p ? E`
              <line class="dial-shaft" x1=${f.toFixed(2)} y1=${v.toFixed(2)}
                    x2=${x.toFixed(2)} y2=${_.toFixed(2)}></line>
              ...
              <polygon class="dial-head" points=${`${ft.toFixed(2)},${m.toFixed(2)} ${it.toFixed(2)},${st.toFixed(2)} ${pe.toFixed(2)},${ue.toFixed(2)}`}></polygon>` : A}
