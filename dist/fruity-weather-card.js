...
const Kt = (e) => new qt(typeof e == "string" ? e : e + "", void 0, St), Te = (e, ...t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: He, defineProperty: Ue, getOwnPropertyDescriptor: ze, getOwnPropertyNames: je, getOwnPropertySymbols: Qe, getPrototypeOf: Le } = Object, xt = globalThis, Pt = xt.trustedTypes, Ne = Pt ? Pt.emptyScript : "", Fe = xt.reactiveElementPolyfillSupport, ht = (e, t) => e, yt = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? Ne : null;
      break;
  ...
  return i;
} }, Bt = (e, t) => !He(e, t), Ht = { attribute: !0, type: String, converter: yt, reflect: !1, useDefault: !1, hasChanged: Bt };
...
let J = class extends HTMLElement {
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      ...
      for (const a of s) i.unshift(Tt(a));
  ...
  requestUpdate(t, i, s, a = !1, o) {
    if (t !== void 0) {
      ...
      if (a === !1 && (o = this[t]), s ??= r.getPropertyOptions(t), !((s.hasChanged ?? Bt)(o, i) || s.useDefault && s.reflect && o === this._$Ej?.get(t) && !this.hasAttribute(r._$Eu(t, s)))) return;
      this.C(t, i, s);
    }
...
J.elementStyles = [], J.shadowRootOptions = { mode: "open" }, J[ht("elementProperties")] = /* @__PURE__ */ new Map(), J[ht("finalized")] = /* @__PURE__ */ new Map(), Fe?.({ ReactiveElement: J }), (xt.reactiveElementVersions ??= []).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ot = globalThis, Ut = (e) => e, wt = Ot.trustedTypes, zt = wt ? wt.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, Wt = "$lit$", j = `lit$${Math.random().toFixed(9).slice(2)}$`, Zt = "?" + j, Xe = `<${Zt}>`, F = document, dt = () => F.createComment(""), ct = (e) => e === null || typeof e != "object" && typeof e != "function", $t = Array.isArray, Ve = (e) => $t(e) || typeof e?.[Symbol.iterator] == "function", kt = `[ 	
\f\r]`, at = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, jt = /-->/g, Qt = />/g, Q = RegExp(`>|${kt}(?:([^\\s"'>=/]+)(${kt}*=${kt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Lt = /'/g, Nt = /"/g, te = /^(?:script|style|textarea|title)$/i, ee = (e) => (t, ...i) => ({ _$litType$: e, strings: t, values: i }), A = ee(1), E = ee(2), q = Symbol.for("lit-noChange"), y = Symbol.for("lit-nothing"), Ft = /* @__PURE__ */ new WeakMap(), N = F.createTreeWalker(F, 129);
function ie(e, t) {
...
const Ye = (e, t) => {
  ...
  for (let n = 0; n < i; n++) {
    const d = e[n];
    let l, p, h = -1, c = 0;
    for (; c < d.length && (r.lastIndex = c, p = r.exec(d), p !== null); ) c = r.lastIndex, r === at ? p[1] === "!--" ? r = jt : p[1] !== void 0 ? r = Qt : p[2] !== void 0 ? (te.test(p[2]) && (a = RegExp("</" + p[2], "g")), r = Q) : p[3] !== void 0 && (r = Q) : r === Q ? p[0] === ">" ? (r = a ?? at, h = -1) : p[1] === void 0 ? h = -2 : (h = r.lastIndex - p[2].length, l = p[1], r = p[3] === void 0 ? Q : p[3] === '"' ? Nt : Lt) : r === Nt || r === Lt ? r = Q : r === jt || r === Qt ? r = at : (r = Q, a = void 0);
    const g = r === Q && e[n + 1].startsWith("/>") ? " " : "";
    o += r === at ? d + Xe : h >= 0 ? (s.push(l), d.slice(0, h) + Wt + d.slice(h) + j + g) : d + j + (h === -2 ? n : g);
  }
    ...
    for (; (a = N.nextNode()) !== null && d.length < n; ) {
      if (a.nodeType === 1) {
        if (a.hasAttributes()) for (const h of a.getAttributeNames()) if (h.endsWith(Wt)) {
          const c = p[r++], g = a.getAttribute(h).split(j), m = /([.?@])?(.*)/.exec(c);
          d.push({ type: 1, index: o, name: m[2], strings: g, ctor: m[1] === "." ? Ge : m[1] === "?" ? qe : m[1] === "@" ? Ke : _t }), a.removeAttribute(h);
        ...
        if (te.test(a.tagName)) {
          ...
          if (c > 0) {
            ...
            for (let g = 0; g < c; g++) a.append(h[g], dt()), N.nextNode(), d.push({ type: 2, index: ++o });
            a.append(h[c], dt());
          }
        }
...
class ut {
  ...
  _$AI(t, i = this) {
    t = K(this, t, i), ct(t) ? t === y || t == null || t === "" ? (this._$AH !== y && this._$AR(), this._$AH = y) : t !== this._$AH && t !== q && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Ve(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _$AC(t) {
    ...
    return i === void 0 && Ft.set(t.strings, i = new pt(t)), i;
  }
  k(t) {
...
class _t {
  ...
  _$AI(t, i = this, s, a) {
    ...
    if (o === void 0) t = K(this, t, i, 0), r = !ct(t) || t !== this._$AH && t !== q, r && (this._$AH = t);
      ...
      const n = t;
      let d, l;
      for (t = o[0], d = 0; d < o.length - 1; d++) l = K(this, n[s + d], i, d), l === q && (l = this._$AH[d]), r ||= !ct(l) || l !== this._$AH[d], l === y ? t = y : t !== y && (t += (l ?? "") + o[d + 1]), this._$AH[d] = l;
    }
    r && !a && this.j(t);
  }
  j(t) {
...
const Ze = Ot.litHtmlPolyfillSupport;
Ze?.(pt, ut), (Ot.litHtmlVersions ??= []).push("3.3.3");
const ti = (e, t, i) => {
...
const ei = Mt.litElementPolyfillSupport;
ei?.({ LitElement: lt });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const si = { attribute: !0, type: String, converter: yt, reflect: !1, hasChanged: Bt }, ai = (e = si, t, i) => {
...
async function hi(e, t) {
  ...
  for (let w = 0; w < $; w++)
    for (let u = 0; u < B; u++)
      s.push((e + (w - ($ - 1) / 2) * Z).toFixed(4)), a.push((t + (u - (B - 1) / 2) * W).toFixed(4));
  ...
  const p = (w) => (/* @__PURE__ */ new Date(`${w}Z`)).getTime(), h = l[0].hourly.time.map(p), c = l[0].minutely_15.time.map(p), g = (w, u) => Array.from({ length: w }, (x, v) => {
    const C = new Float32Array(B * $);
    for (let S = 0; S < l.length; S++) C[S] = u(l[S], v) || 0;
    return C;
  }), m = {
    fetchedAt: Date.now(),
    lat0: e,
    ...
    hourly: {
      times: h,
      frames: g(h.length, (w, u) => w.hourly.precipitation[u])
    },
    quarter: {
      times: c,
      frames: g(c.length, (w, u) => w.minutely_15.precipitation[u])
    }
  };
  return di(m), m;
}
...
const fi = G.slice(1).map(([e, t, i, s]) => `rgb(${t},${i},${s}) ${((e / 15) ** 0.45 * 100).toFixed(0)}%`).join(", ");
function mi(e, t, i, s) {
  ...
  const g = oi(t.lat0, t.lon0), m = (bt(g.west, s.z) * 256 - s.originX) * a, w = (bt(g.east, s.z) * 256 - s.originX) * a, u = (vt(g.north, s.z) * 256 - s.originY) * a, x = (vt(g.south, s.z) * 256 - s.originY) * a;
  n.imageSmoothingEnabled = !0, n.imageSmoothingQuality = "high", n.drawImage(h, m, u, w - m, x - u);
}
function Ai(e, t, i, s) {
  for (let a = 0; a < e.length; a++) s[a] = e[a] + (t[a] - e[a]) * i;
  return s;
}
const ne = "fruity-weather-card:hourly-10d:v2", yi = "/local/fruity-weather-card/precip-hourly.json", wi = "temperature_2m,weather_code,precipitation_probability,precipitation", bi = "precipitation_probability_max", Et = 60 * 60 * 1e3;
function vi(e) {
...
function xi() {
  try {
    ...
    return !t?.fetchedAt || Date.now() - t.fetchedAt > Et ? void 0 : {
...
async function _i() {
  try {
    ...
    if (!t?.fetchedAt || !t.hourly?.time?.length || Date.now() - t.fetchedAt > Et * 3) return;
...
async function Ci(e, t, i = !1) {
  ...
  const d = n.length, l = (w) => w ?? new Array(d).fill(null), p = he({
    time: n,
  ...
  }), h = /* @__PURE__ */ new Map(), c = r.daily?.time ?? [], g = r.daily?.precipitation_probability_max ?? [];
  for (let w = 0; w < c.length; w++) h.set(c[w], g[w] ?? 0);
  const m = { fetchedAt: Date.now(), days: p, dayProb: h };
  return Xt(m), m;
}
function Vt(e) {
...
var Si = Object.defineProperty, Bi = Object.getOwnPropertyDescriptor, O = (e, t, i, s) => {
  for (var a = s > 1 ? void 0 : s ? Bi(t, i) : t, o = e.length - 1, r; o >= 0; o--)
    (r = e[o]) && (a = (s ? r(t, i, a) : r(a)) || a);
  return s && a && Si(t, i, a), a;
};
const Oi = Kt(fi), $i = 20, Mi = "/local/weather-bg", Ei = {
  ...
  cloudy: "night_cloudy",
  rainy: "night_drizzle"
}, Di = { sunrise: "sunrise", sunset: "sunset" }, Ri = [
  ["N", 48, 13, 0],
  ["E", 83, 48, 90],
  ["S", 48, 83, 180],
  ["W", 13, 48, 270]
...
function rt(e, t) {
  return e ? t && Yt[e] ? Yt[e] : Ei[e] ?? "not-available" : "not-available";
}
const Jt = {
  "clear-night": "Clear",
  cloudy: "Cloudy",
...
let b = class extends lt {
  ...
  async _ensureHourly(e = !1) {
    ...
    if (!(t === void 0 || i === void 0 || this._hourlyPending) && !(!e && this._hourlyDays && Date.now() - this._hourlyDays.fetchedAt < Et) && !(!e && Date.now() < this._hourlyRetryAt)) {
  ...
  _dayProb(e) {
    ...
    const i = this._hourlyDays.dayProb.get(Vt(new Date(t.datetime)));
    return i !== void 0 && i >= $i ? i : void 0;
  }
  _openDaySheet(e) {
  ...
  _hoursForDay(e) {
    const t = this._daily[e];
    return !t || !this._hourlyDays ? [] : this._hourlyDays.days.get(Vt(new Date(t.datetime))) ?? [];
  }
  get _mapSeries() {
    const e = this._grid;
  ...
  _timeLabel(e, t = !1) {
    ...
    return A`${i}${s ? A`<span class="ap">${s}</span>` : y}`;
  }
  /**
  ...
  _sunArc() {
    ...
    if (!e || !t) return;
    const i = 864e5, s = Date.now(), a = 0.2, o = 0.8, r = 26, n = 17, d = 11, l = 100, p = (u) => u >= a && u <= o ? Math.sin(Math.PI * (u - a) / (o - a)) : u < a ? -Math.sin(Math.PI * ((a - u) / (2 * a))) : -Math.sin(Math.PI * ((u - o) / (2 * (1 - o)))), h = (u) => r - u * (u >= 0 ? n : d), c = (u, x, v) => {
      const C = [];
      for (let S = 0; S <= v; S++) {
        const U = u + (x - u) * S / v;
        C.push(`${(U * l).toFixed(2)},${h(p(U)).toFixed(2)}`);
      }
      return `M${C.join(" L")}`;
    ...
    if (t < e) {
      ...
      m = x < 0.5 ? o + x / 0.5 * (1 - o) : (x - 0.5) / 0.5 * a;
    }
    const w = p(m);
    return {
      nightPath: c(0, 1, 96),
  ...
  _renderHero(e) {
    const t = this._config.name ?? e.attributes.friendly_name ?? this._config.entity, i = this._override("temperature", "temperature"), s = this._daily[0], a = H(s?.temperature), o = H(s?.templow), r = Jt[e.state] ?? e.state, n = this._tap("hero"), d = this._heroScene(e.state), l = this._config, p = (g) => typeof g == "number" ? `${g}px` : g, h = [], c = (l.backgrounds_path ?? Mi).replace(/\/+$/, "");
    return d && h.push(`--fwc-hero: url("${c}/hero-${d}.jpg?v=2")`), l.hero_bleed_x !== void 0 && h.push(`--fwc-hero-bleed-x: ${p(l.hero_bleed_x)}`), l.hero_bleed_top !== void 0 && h.push(`--fwc-hero-bleed-top: ${p(l.hero_bleed_top)}`), l.hero_extend !== void 0 && h.push(`--fwc-hero-extend: ${p(l.hero_extend)}`), l.hero_radius !== void 0 && h.push(`--fwc-hero-radius: ${p(l.hero_radius)}`), A`
  ...
  _renderHourly() {
    ...
    this._hourly.forEach((h, c) => {
      const g = new Date(h.datetime);
      g.getTime() > i || s.push({
        kind: "hour",
        time: g,
        label: c === 0 ? A`Now` : this._timeLabel(g),
    ...
    const r = this._override("wind_gust"), n = this._overrideUnit("wind_gust", "wind_speed_unit") ?? "km/h", d = Jt[this._weather?.state ?? ""] ?? "", l = d ? `${d} conditions expected for the rest of the day.` + (r !== void 0 ? ` Wind gusts are up to ${k(r)} ${n}.` : "") : "", p = this._tap("hourly");
    return A`
      <div class="panel strip" ?tappable=${!!p}
           @pointerdown=${this._markPointer} @click=${p}>
        ${l ? A`<div class="strip-summary">${l}</div>` : y}
        <div class="row">
          ${s.map((h) => h.kind === "sun" ? A`
                <div class="cell">
                  <div class="cell-label">${h.label}</div>
                  <img class="cell-icon" src=${this._iconUrl(Di[h.event])} alt=${h.event} />
  ...
  _renderDaily() {
    ...
    return A`
      <div class="panel daily" ?tappable=${!!d}
        ...
        ${e.map((l, p) => {
      const h = H(l.templow), c = H(l.temperature), g = new Date(l.datetime), m = p === 0 ? "Today" : g.toLocaleDateString(n, { weekday: "short" }), w = h === void 0 ? 0 : (h - s) / o * 100, u = h === void 0 || c === void 0 ? 0 : (c - h) / o * 100, x = p === 0 && r !== void 0 ? (r - s) / o * 100 : void 0;
      return A`
        ...
        return v === void 0 ? y : A`<span class="dprob">${Math.round(v)}%</span>`;
              ...
              <div class="track">
                <div class="bar" style=${`left:${w}%;width:${u}%;background:linear-gradient(90deg, ${Gt(h ?? s)}, ${Gt(c ?? a)})`}></div>
  ...
  _renderSheetBody(e, t, i) {
    ...
    const s = this._sheetMode === "precip", a = s ? "%" : "°", o = e.map((f) => s ? f.precipProb : f.temp), r = Math.max(...o), n = Math.min(...o), d = e[o.indexOf(r)], l = e[o.indexOf(n)];
    let p, h;
    const c = [];
    if (s)
    ...
    const g = Math.max(h - p, s ? 1 : 5), m = e.length, w = (f) => m > 1 ? f / (m - 1) * 100 : 50, u = (f) => (h - f) / g * 100, x = Date.now();
    let v = null;
    if (m > 1 && x > e[0].time && x < e[m - 1].time) {
      for (let f = 0; f < m - 1; f++)
        if (x < e[f + 1].time) {
          v = f + (x - e[f].time) / (e[f + 1].time - e[f].time);
          break;
        }
    }
    const C = (f) => v !== null && f < v, S = o.map((f, _) => `${w(_)},${u(f)}`).join(" ");
    let U = "", tt = S, et = "", X = `0,100 ${S} 100,100`;
    if (v !== null) {
      const f = Math.floor(v), _ = v - f, D = w(v), R = u(o[f] + (o[f + 1] - o[f]) * _), z = o.slice(0, f + 1).map((it, st) => `${w(st)},${u(it)}`).join(" "), V = o.slice(f + 1).map((it, st) => `${w(f + 1 + st)},${u(it)}`).join(" ");
      U = `${z} ${D},${R}`, tt = `${D},${R} ${V}`, et = `0,100 ${U} ${D},100`, X = `${D},100 ${tt} 100,100`;
    }
    const gt = Math.max(1, Math.round(m / 8)), T = this._hourScrub !== null ? e[this._hourScrub] : void 0, ft = this._hourScrub !== null ? o[this._hourScrub] : void 0;
    return A`
      ...
      <div class="sheet-glyphs">
        ${e.map((f, _) => _ % gt === 0 ? A`<img class="sglyph ${_ === 0 ? "first" : _ === m - 1 ? "last" : ""} ${C(_) ? "past" : ""}"
                      style=${`left:${w(_)}%`}
                      src=${this._iconUrl(rt(f.condition, this._nightAt(new Date(f.time))))}
                      alt=${f.condition} />` : y)}
      </div>

      <div class="sheet-chart">
        <div class="sheet-plot"
             @pointerdown=${(f) => this._scrubAt(f, m)}
             @pointermove=${(f) => this._scrubAt(f, m)}
             @pointerup=${() => {
      this._hourScrub = null;
    }}
             @pointercancel=${() => {
      ...
      this._hourScrub = null;
          ...
          ${c.map((f) => A`
            <div class="sgl" style=${`top:${u(f)}%`}></div>`)}
          ...
          <svg class="scurve ${s ? "precip" : ""}" viewBox="0 0 100 100" preserveAspectRatio="none">
            ...
            ${et ? E`<polygon points=${et} fill="url(#sfillpast)" />` : y}
            <polygon points=${X} fill="url(#sfill)" />
            ${U ? E`<polyline class="past" points=${U} vector-effect="non-scaling-stroke" />` : y}
            <polyline points=${tt} vector-effect="non-scaling-stroke" />
          </svg>
          ${s ? y : (() => {
      const f = u(r), _ = u(n), D = e.indexOf(d), R = e.indexOf(l);
      return A`
              <div class="smark hi ${f < 22 ? "flip" : ""} ${C(D) ? "past" : ""}"
                   style=${`left:${w(D)}%; top:${f}%`}>
                <span>H</span>
              </div>
              <div class="smark lo ${_ > 78 ? "flip" : ""} ${C(R) ? "past" : ""}"
          ...
          ${T ? A`
                <div class="scrub-line ${s ? "precip" : ""}" style=${`left:${w(this._hourScrub)}%`}></div>
                <div class="scrub-dot" style=${`left:${w(this._hourScrub)}%; top:${u(ft)}%`}></div>
              ` : y}
        </div>
        <div class="sheet-yaxis">
          ${c.map((f) => A`<span style=${`top:${u(f)}%`}>${k(f)}${a}</span>`)}
        </div>
      </div>

      <div class="sheet-xaxis">
        ${e.map((f, _) => f.hour % 6 === 0 && f.hour !== 0 ? A`<span class="${_ === m - 1 ? "last" : ""} ${C(_) ? "past" : ""}"
                       style=${`left:${w(_)}%`}>${this._hourLabel(f.hour)}</span>` : y)}
      </div>
    `;
  }
  /**
  ...
  _positionReadout() {
    ...
    e.style.transform = "translateX(0)";
    const o = e.getBoundingClientRect(), r = t.getBoundingClientRect(), n = i.getBoundingClientRect(), d = getComputedStyle(i), l = parseFloat(d.paddingLeft) || 0, p = parseFloat(d.paddingRight) || 0, h = r.left + a * r.width, c = n.left + l - o.left, g = n.right - p - o.width - o.left, m = Math.min(Math.max(h - o.width / 2 - o.left, c), Math.max(g, c));
    e.style.transform = `translateX(${Math.round(m)}px)`;
  }
  ...
  _renderTiles() {
    const { rising: e, setting: t } = this._sunTimes(), i = this._override("feels_like", "apparent_temperature"), s = this._override("temperature", "temperature"), a = this._override("humidity", "humidity"), o = this._override("dew_point", "dew_point"), r = this._override("wind_speed", "wind_speed"), n = this._override("wind_gust"), d = this._override("wind_bearing", "wind_bearing"), l = this._override("precipitation_today"), p = this._overrideUnit("wind_speed", "wind_speed_unit") ?? "km/h", h = this._overrideUnit("wind_gust") ?? p, c = e && t ? e < t : !0, g = i === void 0 || s === void 0 ? "" : Math.abs(i - s) < 0.5 ? "Similar to the actual temperature." : i > s ? "It feels warmer than the actual temperature." : "It feels cooler than the actual temperature.", m = this._daily.find((S) => (H(S.precipitation) ?? 0) > 0), w = this.hass?.locale?.language ?? navigator.language, u = m ? H(m.precipitation) ?? 0 : void 0, x = u === void 0 ? "" : `${u < 1 ? "<1" : Math.round(u)} mm`, v = m ? new Date(m.datetime).toDateString() === (/* @__PURE__ */ new Date()).toDateString() : !1, C = x ? v ? `${x} more expected today.` : `Next expected is ${x} ${new Date(m.datetime).toLocaleDateString(w, { weekday: "short" })}.` : "None expected in the next 10 days.";
    return A`
  ...
  _renderMapTile() {
    ...
    return A`
      ...
      c.stopPropagation(), this._toggleMap();
          ...
          ${this._mapOpen && n?.frames.length && l ? A`
      ...
      return !m && g % 2 !== 0 ? y : A`<span>
                    ${g === 0 ? "Now" : this._timeLabel(new Date(c), m)}
                  </span>`;
    })}
              </div>
            </div>` : y}
          ...
          ${this._mapOpen ? A`<div class="map-credit">${pi}</div>` : y}
        </div>
      </div>
    `;
  }
  ...
  _renderWindTile(e, t, i, s, a) {
    ...
    const l = a !== void 0, p = l ? a + 180 : 0, h = r(p), c = r(p + 180), g = 38, [m, w] = n(g, c), [u, x] = n(g - 3, c), [v, C] = n(24.5, c), [S, U] = n(22.5, h), [tt, et] = n(30, h), X = 1.32, gt = (g + 2 + 30) / 2, T = (g + 2 - 30) / 2 * X, [ft, f] = n(gt + T, h), [_, D] = n(gt - T, h), R = -Math.sin(h), z = Math.cos(h), V = 3.4 * X, it = _ + R * V, st = D + z * V, le = _ - R * V, de = D - z * V, ce = (I) => {
      const P = Math.abs(((p - I) % 360 + 360) % 360);
      return (P > 180 ? 360 - P : P) < 12;
    }, Dt = this._tap("wind");
    return A`
      <div class="tile wide" ?tappable=${!!Dt}
           @pointerdown=${this._markPointer} @click=${Dt}>
          ...
          <svg class="dial" viewBox="0 0 96 96" aria-hidden="true">
            ...
            ${l ? E`
              <line class="dial-shaft" x1=${u.toFixed(2)} y1=${x.toFixed(2)}
                    x2=${v.toFixed(2)} y2=${C.toFixed(2)}></line>
              <line class="dial-shaft" x1=${S.toFixed(2)} y1=${U.toFixed(2)}
                    x2=${tt.toFixed(2)} y2=${et.toFixed(2)}></line>
              <circle class="dial-tail" cx=${m.toFixed(2)} cy=${w.toFixed(2)}
                      r=${(3.2 * X).toFixed(2)}></circle>
              <polygon class="dial-head" points=${`${ft.toFixed(2)},${f.toFixed(2)} ${it.toFixed(2)},${st.toFixed(2)} ${le.toFixed(2)},${de.toFixed(2)}`}></polygon>` : y}
            ...
            ${Ri.map(([I, P, Rt, mt]) => l && ce(mt) ? y : E`
                  <text class="dial-card" x=${P} y=${Rt} text-anchor="middle"
