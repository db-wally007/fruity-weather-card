...
let z = class extends HTMLElement {
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      ...
      for (const a of s) i.unshift(St(a));
...
const Ne = (e, t) => {
  ...
  for (let n = 0; n < i; n++) {
    const d = e[n];
    let l, p, h = -1, c = 0;
    for (; c < d.length && (r.lastIndex = c, p = r.exec(d), p !== null); ) c = r.lastIndex, r === Y ? p[1] === "!--" ? r = Dt : p[1] !== void 0 ? r = Rt : p[2] !== void 0 ? (Ft.test(p[2]) && (a = RegExp("</" + p[2], "g")), r = I) : p[3] !== void 0 && (r = I) : r === I ? p[0] === ">" ? (r = a ?? Y, h = -1) : p[1] === void 0 ? h = -2 : (h = r.lastIndex - p[2].length, l = p[1], r = p[3] === void 0 ? I : p[3] === '"' ? Tt : It) : r === Tt || r === It ? r = I : r === Dt || r === Rt ? r = Y : (r = I, a = void 0);
    const g = r === I && e[n + 1].startsWith("/>") ? " " : "";
    o += r === Y ? d + je : h >= 0 ? (s.push(l), d.slice(0, h) + Lt + d.slice(h) + R + g) : d + R + (h === -2 ? n : g);
  }
...
class Z {
  constructor({ strings: t, _$litType$: i }, s) {
    ...
    this.parts = [];
    let o = 0, r = 0;
    const n = t.length - 1, d = this.parts, [l, p] = Ne(t, i);
    if (this.el = Z.createElement(l, s), H.currentNode = this.el.content, i === 2 || i === 3) {
      const h = this.el.content.firstChild;
      h.replaceWith(...h.childNodes);
    }
    for (; (a = H.nextNode()) !== null && d.length < n; ) {
      if (a.nodeType === 1) {
        if (a.hasAttributes()) for (const h of a.getAttributeNames()) if (h.endsWith(Lt)) {
          const c = p[r++], g = a.getAttribute(h).split(R), f = /([.?@])?(.*)/.exec(c);
          d.push({ type: 1, index: o, name: f[2], strings: g, ctor: f[1] === "." ? Xe : f[1] === "?" ? Ye : f[1] === "@" ? Ve : lt }), a.removeAttribute(h);
        } else h.startsWith(R) && (d.push({ type: 6, index: o }), a.removeAttribute(h));
        if (Ft.test(a.tagName)) {
          const h = a.textContent.split(R), c = h.length - 1;
          if (c > 0) {
            a.textContent = ot ? ot.emptyScript : "";
            for (let g = 0; g < c; g++) a.append(h[g], q()), H.nextNode(), d.push({ type: 2, index: ++o });
            a.append(h[c], q());
          }
        }
        ...
        let h = -1;
        for (; (h = a.data.indexOf(R, h + 1)) !== -1; ) d.push({ type: 7, index: o }), h += R.length - 1;
      }
      o++;
    }
  }
...
class Fe {
  ...
  u(t) {
    ...
    H.currentNode = a;
    let o = H.nextNode(), r = 0, n = 0, d = s[0];
    for (; d !== void 0; ) {
      if (r === d.index) {
        let l;
        d.type === 2 ? l = new tt(o, o.nextSibling, this, t) : d.type === 1 ? l = new d.ctor(o, d.name, d.strings, this, t) : d.type === 6 && (l = new Je(o, this, t)), this._$AV.push(l), d = s[++n];
      }
...
class tt {
  ...
  _$AI(t, i = this) {
    t = N(this, t, i), W(t) ? t === w || t == null || t === "" ? (this._$AH !== w && this._$AR(), this._$AH = w) : t !== this._$AH && t !== L && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Le(t) ? this.k(t) : this._(t);
  }
  O(t) {
...
class lt {
  ...
  _$AI(t, i = this, s, a) {
    ...
    if (o === void 0) t = N(this, t, i, 0), r = !W(t) || t !== this._$AH && t !== L, r && (this._$AH = t);
      ...
      const n = t;
      let d, l;
      for (t = o[0], d = 0; d < o.length - 1; d++) l = N(this, n[s + d], i, d), l === L && (l = this._$AH[d]), r ||= !W(l) || l !== this._$AH[d], l === w ? t = w : t !== w && (t += (l ?? "") + o[d + 1]), this._$AH[d] = l;
    }
    r && !a && this.j(t);
  }
  j(t) {
...
const O = 13, S = 11, F = 0.48, X = 0.375;
function ei(e, t) {
  return {
    north: e + (S - 1) / 2 * X,
    south: e - (S - 1) / 2 * X,
...
function Jt(e) {
  return e.nx === O && e.ny === S && Math.abs((e.dlon ?? 0) - F) < 1e-6 && Math.abs((e.dlat ?? 0) - X) < 1e-6;
}
...
async function ai(e, t) {
  ...
  for (let b = 0; b < S; b++)
    for (let u = 0; u < O; u++)
      s.push((e + (b - (S - 1) / 2) * X).toFixed(4)), a.push((t + (u - (O - 1) / 2) * F).toFixed(4));
  ...
  if (l.length !== O * S)
    throw new Error(`open-meteo returned ${l.length} of ${O * S} points`);
  const p = (b) => (/* @__PURE__ */ new Date(`${b}Z`)).getTime(), h = l[0].hourly.time.map(p), c = l[0].minutely_15.time.map(p), g = (b, u) => Array.from({ length: b }, (x, k) => {
    const v = new Float32Array(O * S);
...
function pi(e, t, i, s) {
  ...
  if (!l) return;
  const p = l.createImageData(O, S);
  for (let k = 0; k < S; k++)
    for (let v = 0; v < O; v++) {
      const A = (S - 1 - k) * O + v;
      di(i[A], p.data, (k * O + v) * 4);
    }
  l.putImageData(p, 0, 0);
  const h = document.createElement("canvas");
  h.width = O * 6, h.height = S * 6;
  ...
  n.imageSmoothingEnabled = !0, n.imageSmoothingQuality = "high", n.drawImage(h, f, u, b - f, x - u);
}
function gi(e, t, i, s) {
...
async function mi(e, t, i = !1) {
  ...
  const o = await a.json(), r = o.hourly?.time ?? [], n = o.hourly?.temperature_2m ?? [], d = o.hourly?.weather_code ?? [];
  ...
  for (let h = 0; h < r.length; h++) {
    ...
    x.push({ hour: b, time: u, temp: g, condition: ui(d[h] ?? 3) }), l.set(f, x);
  }
...
var yi = Object.defineProperty, bi = Object.getOwnPropertyDescriptor, B = (e, t, i, s) => {
...
let y = class extends K {
  ...
  _paintMap() {
    ...
    let h = r.frames[l];
    p !== l && ((!this._mapScratch || this._mapScratch.length !== h.length) && (this._mapScratch = new Float32Array(h.length)), h = gi(r.frames[l], r.frames[p], d - l, this._mapScratch)), pi(o, this._grid, h, s);
  }
  /**
  ...
  async _reflowGrid(e, t = () => !0) {
    ...
    if (e(), await this.updateComplete, y._reducedMotion()) return;
    ...
    requestAnimationFrame(() => requestAnimationFrame(() => {
      for (const r of o)
        r.style.transform && (r.style.transition = `transform 420ms ${y.SPRING}`, r.style.transform = "", r.addEventListener("transitionend", () => {
          r.style.transition = "";
        }, { once: !0 }));
    }));
  }
  ...
  _sunArc() {
    ...
    if (!e || !t) return;
    const i = 864e5, s = Date.now(), a = 0.2, o = 0.8, r = 26, n = 17, d = 11, l = 100, p = (u) => u >= a && u <= o ? Math.sin(Math.PI * (u - a) / (o - a)) : u < a ? -Math.sin(Math.PI * ((a - u) / (2 * a))) : -Math.sin(Math.PI * ((u - o) / (2 * (1 - o)))), h = (u) => r - u * (u >= 0 ? n : d), c = (u, x, k) => {
      const v = [];
      for (let A = 0; A <= k; A++) {
        const C = u + (x - u) * A / k;
        v.push(`${(C * l).toFixed(2)},${h(p(C)).toFixed(2)}`);
      }
      return `M${v.join(" L")}`;
  ...
  _renderHero(e) {
    const t = this._config.name ?? e.attributes.friendly_name ?? this._config.entity, i = this._override("temperature", "temperature"), s = this._daily[0], a = D(s?.temperature), o = D(s?.templow), r = Ut[e.state] ?? e.state, n = this._tap("hero"), d = this._heroScene(e.state), l = this._config, p = (g) => typeof g == "number" ? `${g}px` : g, h = [], c = (l.backgrounds_path ?? xi).replace(/\/+$/, "");
    return d && h.push(`--fwc-hero: url("${c}/hero-${d}.jpg?v=2")`), l.hero_bleed_x !== void 0 && h.push(`--fwc-hero-bleed-x: ${p(l.hero_bleed_x)}`), l.hero_bleed_top !== void 0 && h.push(`--fwc-hero-bleed-top: ${p(l.hero_bleed_top)}`), l.hero_extend !== void 0 && h.push(`--fwc-hero-extend: ${p(l.hero_extend)}`), l.hero_radius !== void 0 && h.push(`--fwc-hero-radius: ${p(l.hero_radius)}`), m`
  ...
  _renderHourly() {
    ...
    const r = this._override("wind_gust"), n = this._overrideUnit("wind_gust", "wind_speed_unit") ?? "km/h", d = Ut[this._weather?.state ?? ""] ?? "", l = d ? `${d} conditions expected for the rest of the day.` + (r !== void 0 ? ` Wind gusts are up to ${_(r)} ${n}.` : "") : "", p = this._tap("hourly");
    return m`
      <div class="panel strip" ?tappable=${!!p}
           @pointerdown=${this._markPointer} @click=${p}>
        ${l ? m`<div class="strip-summary">${l}</div>` : w}
        <div class="row">
          ${s.map((h) => h.kind === "sun" ? m`
                ...
                <div class="cell">
                  <div class="cell-label">${h.label}</div>
                  <img class="cell-icon" src=${this._iconUrl(V(h.condition, this._nightAt(h.time)))} alt=${h.condition} />
  ...
  _renderDaily() {
    ...
    const t = e.map((l) => D(l.templow)).filter((l) => l !== void 0), i = e.map((l) => D(l.temperature)).filter((l) => l !== void 0), s = Math.min(...t, ...i), a = Math.max(...t, ...i), o = Math.max(a - s, 1), r = this._override("temperature", "temperature"), n = this.hass?.locale?.language ?? navigator.language, d = this._tap("daily");
    return m`
      <div class="panel daily" ?tappable=${!!d}
           @pointerdown=${this._markPointer} @click=${d}>
        <div class="panel-head">${e.length}-DAY FORECAST</div>
        ${e.map((l, p) => {
      const h = D(l.templow), c = D(l.temperature), g = new Date(l.datetime), f = p === 0 ? "Today" : g.toLocaleDateString(n, { weekday: "short" }), b = h === void 0 ? 0 : (h - s) / o * 100, u = h === void 0 || c === void 0 ? 0 : (c - h) / o * 100, x = p === 0 && r !== void 0 ? (r - s) / o * 100 : void 0;
      return m`
        ...
        k.stopPropagation(), !this._movedSincePointer(k) && (this._sheetDay === p ? this._closeDaySheet() : this._openDaySheet(p));
              ...
              <div class="track">
                <div class="bar" style=${`left:${b}%;width:${u}%;background:linear-gradient(90deg, ${Qt(h ?? s)}, ${Qt(c ?? a)})`}></div>
  ...
  _renderSheetBody(e, t, i) {
    ...
    const s = e.map((A) => A.temp), a = Math.max(...s), o = Math.min(...s), r = e[s.indexOf(a)], n = e[s.indexOf(o)], d = 5, l = Math.floor(o / d) * d, p = Math.ceil(a / d) * d, h = Math.max(p - l, d), c = [];
    for (let A = p; A >= l - 1e-3; A -= d) c.push(A);
    const g = e.length, f = (A) => g > 1 ? A / (g - 1) * 100 : 50, b = (A) => (p - A) / h * 100, u = e.map((A, C) => `${f(C)},${b(A.temp)}`).join(" "), x = `0,100 ${u} 100,100`, k = Math.max(1, Math.round(g / 8)), v = this._hourScrub !== null ? e[this._hourScrub] : void 0;
    return m`
      ...
      const A = b(a), C = b(o);
      return m`
              <div class="smark hi ${A < 22 ? "flip" : ""}"
                   style=${`left:${f(e.indexOf(r))}%; top:${A}%`}>
                <span>H</span>
              </div>
              <div class="smark lo ${C > 78 ? "flip" : ""}"
                   style=${`left:${f(e.indexOf(n))}%; top:${C}%`}>
                <span>L</span>
              </div>
            `;
    })()}
  ...
  _positionReadout() {
    ...
    e.style.transform = "translateX(0)";
    const o = e.getBoundingClientRect(), r = t.getBoundingClientRect(), n = i.getBoundingClientRect(), d = getComputedStyle(i), l = parseFloat(d.paddingLeft) || 0, p = parseFloat(d.paddingRight) || 0, h = r.left + a * r.width, c = n.left + l - o.left, g = n.right - p - o.width - o.left, f = Math.min(Math.max(h - o.width / 2 - o.left, c), Math.max(g, c));
  ...
  _hourLabel(e) {
    ...
    return m`${o.trim()}${r ? m`<span class="ap">${r}</span>` : w}`;
  }
  /**
  ...
  _renderMapTile() {
    ...
    const n = e ? this._mapSeries : void 0, d = n ? Math.min(this._mapFrame, n.frames.length - 1) : 0, l = n ? new Date(n.times[d]) : void 0, p = this._config?.map_style ?? "dark", h = t ? li(t, p) : [];
    return m`
      ...
      c.stopPropagation(), this._toggleMap();
          ...
          ${this._mapOpen && n?.frames.length && l ? m`
  ...
  _renderWindTile(e, t, i, s, a) {
    ...
    for (let M = 0; M < 72; M++) {
      ...
      const it = r($), [he, le] = n(31, it), [de, ce] = n(39, it);
      d += `M${he.toFixed(2)},${le.toFixed(2)}L${de.toFixed(2)},${ce.toFixed(2)}`;
    }
    const l = a !== void 0, p = l ? a + 180 : 0, h = r(p), c = r(p + 180), g = 38, [f, b] = n(g, c), [u, x] = n(g - 3, c), [k, v] = n(24.5, c), [A, C] = n(22.5, h), [Zt, te] = n(30, h), dt = 1.32, wt = (g + 2 + 30) / 2, yt = (g + 2 - 30) / 2 * dt, [ee, ie] = n(wt + yt, h), [bt, vt] = n(wt - yt, h), xt = -Math.sin(h), _t = Math.cos(h), et = 3.4 * dt, se = bt + xt * et, ae = vt + _t * et, oe = bt - xt * et, re = vt - _t * et, ne = (M) => {
...
y.SPRING = "cubic-bezier(0.34, 1.42, 0.64, 1)";
y.FRAME_SECONDS = 0.9;
y.ZOOM_MIN = 8;
y.ZOOM_MAX = 11;
