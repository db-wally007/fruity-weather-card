 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Re, defineProperty: Ie, getOwnPropertyDescriptor: Pe, getOwnPropertyNames: He, getOwnPropertySymbols: Te, getPrototypeOf: Ue } = Object, ht = globalThis, Et = ht.trustedTypes, Qe = Et ? Et.emptyScript : "", je = ht.reactiveElementPolyfillSupport, J = (e, t) => e, at = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? Qe : null;
      break;
  ...
  return i;
} }, ut = (e, t) => !Re(e, t), St = { attribute: !0, type: String, converter: at, reflect: !1, useDefault: !1, hasChanged: ut };
...
let Q = class extends HTMLElement {
  ...
  static getPropertyDescriptor(t, i, s) {
    const { get: a, set: o } = Pe(this.prototype, t) ?? { get() {
      return this[i];
    }, set(r) {
      this[i] = r;
    } };
...
Q.elementStyles = [], Q.shadowRootOptions = { mode: "open" }, Q[J("elementProperties")] = /* @__PURE__ */ new Map(), Q[J("finalized")] = /* @__PURE__ */ new Map(), je?.({ ReactiveElement: Q }), (ht.reactiveElementVersions ??= []).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const At = globalThis, Mt = (e) => e, ot = At.trustedTypes, $t = ot ? ot.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, Lt = "$lit$", R = `lit$${Math.random().toFixed(9).slice(2)}$`, Nt = "?" + R, ze = `<${Nt}>`, T = document, G = () => T.createComment(""), W = (e) => e === null || typeof e != "object" && typeof e != "function", ft = Array.isArray, Le = (e) => ft(e) || typeof e?.[Symbol.iterator] == "function", ct = `[ 	
\f\r]`, X = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Dt = /-->/g, Rt = />/g, I = RegExp(`>|${ct}(?:([^\\s"'>=/]+)(${ct}*=${ct}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), It = /'/g, Pt = /"/g, Ft = /^(?:script|style|textarea|title)$/i, Xt = (e) => (t, ...i) => ({ _$litType$: e, strings: t, values: i }), y = Xt(1), D = Xt(2), z = Symbol.for("lit-noChange"), f = Symbol.for("lit-nothing"), Ht = /* @__PURE__ */ new WeakMap(), H = T.createTreeWalker(T, 129);
function Yt(e, t) {
...
const Ne = (e, t) => {
  ...
  let a, o = t === 2 ? "<svg>" : t === 3 ? "<math>" : "", r = X;
  for (let h = 0; h < i; h++) {
    const l = e[h];
    let d, p, n = -1, c = 0;
    for (; c < l.length && (r.lastIndex = c, p = r.exec(l), p !== null); ) c = r.lastIndex, r === X ? p[1] === "!--" ? r = Dt : p[1] !== void 0 ? r = Rt : p[2] !== void 0 ? (Ft.test(p[2]) && (a = RegExp("</" + p[2], "g")), r = I) : p[3] !== void 0 && (r = I) : r === I ? p[0] === ">" ? (r = a ?? X, n = -1) : p[1] === void 0 ? n = -2 : (n = r.lastIndex - p[2].length, d = p[1], r = p[3] === void 0 ? I : p[3] === '"' ? Pt : It) : r === Pt || r === It ? r = I : r === Dt || r === Rt ? r = X : (r = I, a = void 0);
    const g = r === I && e[h + 1].startsWith("/>") ? " " : "";
    o += r === X ? l + ze : n >= 0 ? (s.push(d), l.slice(0, n) + Lt + l.slice(n) + R + g) : l + R + (n === -2 ? h : g);
  }
...
class q {
  constructor({ strings: t, _$litType$: i }, s) {
    ...
    this.parts = [];
    let o = 0, r = 0;
    const h = t.length - 1, l = this.parts, [d, p] = Ne(t, i);
    if (this.el = q.createElement(d, s), H.currentNode = this.el.content, i === 2 || i === 3) {
      const n = this.el.content.firstChild;
      n.replaceWith(...n.childNodes);
    }
    for (; (a = H.nextNode()) !== null && l.length < h; ) {
      if (a.nodeType === 1) {
        if (a.hasAttributes()) for (const n of a.getAttributeNames()) if (n.endsWith(Lt)) {
          const c = p[r++], g = a.getAttribute(n).split(R), A = /([.?@])?(.*)/.exec(c);
          l.push({ type: 1, index: o, name: A[2], strings: g, ctor: A[1] === "." ? Xe : A[1] === "?" ? Ye : A[1] === "@" ? Ve : lt }), a.removeAttribute(n);
        } else n.startsWith(R) && (l.push({ type: 6, index: o }), a.removeAttribute(n));
        if (Ft.test(a.tagName)) {
          const n = a.textContent.split(R), c = n.length - 1;
          if (c > 0) {
            a.textContent = ot ? ot.emptyScript : "";
            for (let g = 0; g < c; g++) a.append(n[g], G()), H.nextNode(), l.push({ type: 2, index: ++o });
            a.append(n[c], G());
          }
        }
        ...
        let n = -1;
        for (; (n = a.data.indexOf(R, n + 1)) !== -1; ) l.push({ type: 7, index: o }), n += R.length - 1;
      }
      o++;
    }
  }
...
function L(e, t, i = e, s) {
  ...
  return a?.constructor !== o && (a?._$AO?.(!1), o === void 0 ? a = void 0 : (a = new o(e), a._$AT(e, i, s)), s !== void 0 ? (i._$Co ??= [])[s] = a : i._$Cl = a), a !== void 0 && (t = L(e, a._$AS(e, t.values), a, s)), t;
}
class Fe {
  constructor(t, i) {
  ...
  u(t) {
    const { el: { content: i }, parts: s } = this._$AD, a = (t?.creationScope ?? T).importNode(i, !0);
    H.currentNode = a;
    let o = H.nextNode(), r = 0, h = 0, l = s[0];
    for (; l !== void 0; ) {
      if (r === l.index) {
        let d;
        l.type === 2 ? d = new Z(o, o.nextSibling, this, t) : l.type === 1 ? d = new l.ctor(o, l.name, l.strings, this, t) : l.type === 6 && (d = new Je(o, this, t)), this._$AV.push(d), l = s[++h];
      }
      r !== l?.index && (o = H.nextNode(), r++);
    }
    return H.currentNode = T, a;
  }
  p(t) {
    let i = 0;
...
class Z {
  ...
  constructor(t, i, s, a) {
    this.type = 2, this._$AH = f, this._$AN = void 0, this._$AA = t, this._$AB = i, this._$AM = s, this.options = a, this._$Cv = a?.isConnected ?? !0;
  }
  get parentNode() {
  ...
  _$AI(t, i = this) {
    t = L(this, t, i), W(t) ? t === f || t == null || t === "" ? (this._$AH !== f && this._$AR(), this._$AH = f) : t !== this._$AH && t !== z && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Le(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== f && W(this._$AH) ? this._$AA.nextSibling.data = t : this.T(T.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    const { values: i, _$litType$: s } = t, a = typeof s == "number" ? this._$AC(t) : (s.el === void 0 && (s.el = q.createElement(Yt(s.h, s.h[0]), this.options)), s);
  ...
  _$AC(t) {
    ...
    return i === void 0 && Ht.set(t.strings, i = new q(t)), i;
  }
  k(t) {
    ft(this._$AH) || (this._$AH = [], this._$AR());
    const i = this._$AH;
    let s, a = 0;
    for (const o of t) a === i.length ? i.push(s = new Z(this.O(G()), this.O(G()), this, this.options)) : s = i[a], s._$AI(o), a++;
...
class lt {
  ...
  constructor(t, i, s, a, o) {
    this.type = 1, this._$AH = f, this._$AN = void 0, this.element = t, this.name = i, this._$AM = a, this.options = o, s.length > 2 || s[0] !== "" || s[1] !== "" ? (this._$AH = Array(s.length - 1).fill(new String()), this.strings = s) : this._$AH = f;
  }
  _$AI(t, i = this, s, a) {
    const o = this.strings;
    let r = !1;
    if (o === void 0) t = L(this, t, i, 0), r = !W(t) || t !== this._$AH && t !== z, r && (this._$AH = t);
    else {
      const h = t;
      let l, d;
      for (t = o[0], l = 0; l < o.length - 1; l++) d = L(this, h[s + l], i, l), d === z && (d = this._$AH[l]), r ||= !W(d) || d !== this._$AH[l], d === f ? t = f : t !== f && (t += (d ?? "") + o[l + 1]), this._$AH[l] = d;
    }
    r && !a && this.j(t);
  }
  j(t) {
...
class Ve extends lt {
  ...
  _$AI(t, i = this) {
    if ((t = L(this, t, i, 0) ?? f) === z) return;
    const s = this._$AH, a = t === f && s !== f || t.capture !== s.capture || t.once !== s.once || t.passive !== s.passive, o = t !== f && (s === f || a);
...
Ke?.(q, Z), (At.litHtmlVersions ??= []).push("3.3.3");
const Ge = (e, t, i) => {
  const s = i?.renderBefore ?? t;
  let a = s._$litPart$;
  if (a === void 0) {
    const o = i?.renderBefore ?? null;
    s._$litPart$ = a = new Z(t.insertBefore(G(), o), o, void 0, i ?? {});
  }
  return a._$AI(e), a;
};
/**
...
const Ze = { attribute: !0, type: String, converter: at, reflect: !1, hasChanged: ut }, ti = (e = Ze, t, i) => {
  ...
  if (o === void 0 && globalThis.litPropertyMetadata.set(a, o = /* @__PURE__ */ new Map()), s === "setter" && ((e = Object.create(e)).wrapped = !0), o.set(i.name, e), s === "accessor") {
    ...
    return { set(h) {
      ...
      t.set.call(this, h), this.requestUpdate(r, l, e, !0, h);
    }, init(h) {
  ...
  if (s === "setter") {
    ...
    return function(h) {
      const l = this[r];
      t.call(this, h), this.requestUpdate(r, l, e, !0, h);
    };
  }
...
const C = 13, O = 11, N = 0.48, F = 0.375;
function ei(e, t) {
  return {
    north: e + (O - 1) / 2 * F,
    south: e - (O - 1) / 2 * F,
...
function Jt(e) {
  return e.nx === C && e.ny === O && Math.abs((e.dlon ?? 0) - N) < 1e-6 && Math.abs((e.dlat ?? 0) - F) < 1e-6;
}
...
async function ai(e, t) {
  ...
  for (let b = 0; b < O; b++)
    for (let u = 0; u < C; u++)
      s.push((e + (b - (O - 1) / 2) * F).toFixed(4)), a.push((t + (u - (C - 1) / 2) * N).toFixed(4));
  ...
  const l = await h.json(), d = Array.isArray(l) ? l : [l];
  if (d.length !== C * O)
    throw new Error(`open-meteo returned ${d.length} of ${C * O} points`);
  const p = (b) => (/* @__PURE__ */ new Date(`${b}Z`)).getTime(), n = d[0].hourly.time.map(p), c = d[0].minutely_15.time.map(p), g = (b, u) => Array.from({ length: b }, (v, _) => {
    const m = new Float32Array(C * O);
    for (let x = 0; x < d.length; x++) m[x] = u(d[x], _) || 0;
    return m;
  }), A = {
    fetchedAt: Date.now(),
    lat0: e,
...
function li(e, t = "dark") {
  const i = "https://services.arcgisonline.com/ArcGIS/rest/services/Canvas", s = t === "dark" ? "Dark" : "Light", a = e.z, o = 256, r = 2 ** a, h = [], l = Math.floor(e.originX / o), d = Math.floor(e.originY / o), p = Math.floor((e.originX + e.width) / o), n = Math.floor((e.originY + e.height) / o);
  for (let c = d; c <= n; c++)
    if (!(c < 0 || c >= r))
      for (let g = l; g <= p; g++) {
        const A = (g % r + r) % r;
...
function pi(e, t, i, s) {
  ...
  if (!d) return;
  const p = d.createImageData(C, O);
  for (let _ = 0; _ < O; _++)
    for (let m = 0; m < C; m++) {
      const x = (O - 1 - _) * C + m;
      di(i[x], p.data, (_ * C + m) * 4);
    }
  ...
  if (!c) return;
  c.imageSmoothingEnabled = !0, c.imageSmoothingQuality = "high", c.drawImage(l, 0, 0, n.width, n.height);
  const g = ei(t.lat0, t.lon0), A = (rt(g.west, s.z) * 256 - s.originX) * a, b = (rt(g.east, s.z) * 256 - s.originX) * a, u = (nt(g.north, s.z) * 256 - s.originY) * a, v = (nt(g.south, s.z) * 256 - s.originY) * a;
  h.imageSmoothingEnabled = !0, h.imageSmoothingQuality = "high", h.drawImage(n, A, u, b - A, v - u);
}
function gi(e, t, i, s) {
  for (let a = 0; a < e.length; a++) s[a] = e[a] + (t[a] - e[a]) * i;
  return s;
}
const Wt = "fruity-weather-card:hourly-10d:v1", qt = 60 * 60 * 1e3;
function ui(e) {
...
function Ai() {
  try {
    ...
    return !t?.fetchedAt || Date.now() - t.fetchedAt > qt ? void 0 : { fetchedAt: t.fetchedAt, days: new Map(Object.entries(t.days)) };
  } catch {
    return;
  }
}
...
async function mi(e, t, i = !1) {
  ...
  const o = await a.json(), r = o.hourly?.time ?? [], h = o.hourly?.temperature_2m ?? [], l = o.hourly?.weather_code ?? [];
  if (!r.length) throw new Error("open-meteo hourly returned no points");
  const d = /* @__PURE__ */ new Map();
  for (let n = 0; n < r.length; n++) {
    const c = r[n], g = h[n];
    if (g == null) continue;
    const A = c.slice(0, 10), b = Number(c.slice(11, 13)), u = (/* @__PURE__ */ new Date(`${c}:00`)).getTime(), v = d.get(A) ?? [];
    v.push({ hour: b, time: u, temp: g, condition: ui(l[n] ?? 3) }), d.set(A, v);
  }
...
var wi = Object.defineProperty, bi = Object.getOwnPropertyDescriptor, B = (e, t, i, s) => {
...
function Y(e, t) {
  return e ? t && Tt[e] ? Tt[e] : _i[e] ?? "not-available" : "not-available";
}
const Ut = {
  "clear-night": "Clear",
  cloudy: "Cloudy",
...
function Qt(e) {
  ...
  for (let i = 0; i < P.length - 1; i++) {
    ...
    if (e >= s && e <= o) {
      const h = (e - s) / (o - s);
      return `rgb(${a.map((d, p) => Math.round(d + (r[p] - d) * h)).join(",")})`;
    }
  }
  return "#ffffff";
}
...
}, k = (e) => e === void 0 ? "--" : `${Math.round(e)}`, V = (e) => y`
...
let w = class extends K {
  constructor() {
    super(...arguments), this._hourly = [], this._daily = [], this._mapOpen = !1, this._mapFrame = 0, this._mapPlaying = !1, this._sheetDay = null, this._hourlyError = !1, this._hourlyPending = !1, this._mapRange = "12h", this._mapSeen = !1, this._mapT = 0, this._mapLast = 0, this._gridPending = !1, this._gridRetryAt = 0, this._gridBackoff = 0, this._advance = (e) => {
  ...
  async _ensureHourly(e = !1) {
    ...
    if (!(t === void 0 || i === void 0 || this._hourlyPending) && !(!e && this._hourlyDays && Date.now() - this._hourlyDays.fetchedAt < qt)) {
  ...
  _openDaySheet(e) {
    this._sheetDay = e, this._ensureHourly();
  }
  _closeDaySheet() {
    this._sheetDay = null;
  }
  ...
  _paintMap() {
    ...
    if (!h) return;
    const l = Math.min(Math.max(this._mapT, 0), h - 1e-6), d = Math.floor(l), p = Math.min(d + 1, h - 1);
    let n = r.frames[d];
    p !== d && ((!this._mapScratch || this._mapScratch.length !== n.length) && (this._mapScratch = new Float32Array(n.length)), n = gi(r.frames[d], r.frames[p], l - d, this._mapScratch)), pi(o, this._grid, n, s);
  }
  /**
  ...
  async _toggleMap() {
    ...
    if (this._mapOpen = !this._mapOpen, this._mapOpen || (this._stopPlayback(), this._mapT = 0, this._mapFrame = 0), await this.updateComplete, this._mapOpen && !e && this._autoPlay(), !e) {
      for (const a of i) {
        const o = s.get(a), r = a.getBoundingClientRect(), h = o.left - r.left, l = o.top - r.top;
        !h && !l || (a.style.transition = "none", a.style.transform = `translate(${h}px, ${l}px)`);
      }
  ...
  _override(e, t) {
    ...
    if (i) {
      ...
      if (s && s.state !== "unavailable" && s.state !== "unknown") return $(s.state);
    }
  ...
  _timeLabel(e, t = !1) {
    ...
    return y`${i}${s ? y`<span class="ap">${s}</span>` : f}`;
  }
  /**
  ...
  _sunArc() {
    ...
    if (!e || !t) return;
    const i = 864e5, s = Date.now(), a = 0.2, o = 0.8, r = 26, h = 17, l = 11, d = 100, p = (u) => u >= a && u <= o ? Math.sin(Math.PI * (u - a) / (o - a)) : u < a ? -Math.sin(Math.PI * ((a - u) / (2 * a))) : -Math.sin(Math.PI * ((u - o) / (2 * (1 - o)))), n = (u) => r - u * (u >= 0 ? h : l), c = (u, v, _) => {
      const m = [];
      for (let x = 0; x <= _; x++) {
        const tt = u + (v - u) * x / _;
        m.push(`${(tt * d).toFixed(2)},${n(p(tt)).toFixed(2)}`);
      }
      return `M${m.join(" L")}`;
    ...
    if (t < e) {
      ...
      A = v < 0.5 ? o + v / 0.5 * (1 - o) : (v - 0.5) / 0.5 * a;
    }
    const b = p(A);
    return {
      nightPath: c(0, 1, 96),
  ...
  _iconUrl(e) {
    ...
    return t ? `${t.replace(/\/+$/, "")}/${e}.png` : new URL((/* @__PURE__ */ Object.assign({ "../icons/clear.png": ge, "../icons/cloudy.png": ue, "../icons/drizzle.png": Ae, "../icons/fog.png": fe, "../icons/freezing_rain.png": me, "../icons/haze.png": ye, "../icons/heavy_rain.png": we, "../icons/heavy_snow.png": be, "../icons/night_clear.png": ve, "../icons/night_cloudy.png": xe, "../icons/night_drizzle.png": _e, "../icons/partly_cloudy.png": ke, "../icons/rain.png": Ce, "../icons/snow.png": Oe, "../icons/sunrise.png": Be, "../icons/sunset.png": Ee, "../icons/thunderstorm.png": Se, "../icons/windy.png": Me }))[`../icons/${e}.png`], import.meta.url).href;
  }
  // -- render ---------------------------------------------------------------
  render() {
  ...
  _renderHero(e) {
    const t = this._config.name ?? e.attributes.friendly_name ?? this._config.entity, i = this._override("temperature", "temperature"), s = this._daily[0], a = $(s?.temperature), o = $(s?.templow), r = Ut[e.state] ?? e.state, h = this._tap("hero"), l = this._heroScene(e.state), d = this._config, p = (g) => typeof g == "number" ? `${g}px` : g, n = [], c = (d.backgrounds_path ?? xi).replace(/\/+$/, "");
    return l && n.push(`--fwc-hero: url("${c}/hero-${l}.jpg?v=2")`), d.hero_bleed_x !== void 0 && n.push(`--fwc-hero-bleed-x: ${p(d.hero_bleed_x)}`), d.hero_bleed_top !== void 0 && n.push(`--fwc-hero-bleed-top: ${p(d.hero_bleed_top)}`), d.hero_extend !== void 0 && n.push(`--fwc-hero-extend: ${p(d.hero_extend)}`), d.hero_radius !== void 0 && n.push(`--fwc-hero-radius: ${p(d.hero_radius)}`), y`
      <div class="hero ${l ? "has-bg" : ""}" ?tappable=${!!h}
           style=${n.join("; ")}
  ...
  _renderHourly() {
    if (!this._hourly.length) return f;
    ...
    this._hourly.forEach((n, c) => {
      ...
      g.getTime() > i || s.push({
        kind: "hour",
        time: g,
        label: c === 0 ? y`Now` : this._timeLabel(g),
    ...
    const r = this._override("wind_gust"), h = this._overrideUnit("wind_gust", "wind_speed_unit") ?? "km/h", l = Ut[this._weather?.state ?? ""] ?? "", d = l ? `${l} conditions expected for the rest of the day.` + (r !== void 0 ? ` Wind gusts are up to ${k(r)} ${h}.` : "") : "", p = this._tap("hourly");
    return y`
      <div class="panel strip" ?tappable=${!!p}
           @pointerdown=${this._markPointer} @click=${p}>
        ${d ? y`<div class="strip-summary">${d}</div>` : f}
        <div class="row">
          ${s.map((n) => n.kind === "sun" ? y`
                <div class="cell">
                ...
                <div class="cell">
                  <div class="cell-label">${n.label}</div>
                  <img class="cell-icon" src=${this._iconUrl(Y(n.condition, this._nightAt(n.time)))} alt=${n.condition} />
                  <div class="cell-val">${k(n.temp)}°</div>
                </div>`)}
        </div>
      </div>
    `;
  ...
  _renderDaily() {
    ...
    const t = e.map((d) => $(d.templow)).filter((d) => d !== void 0), i = e.map((d) => $(d.temperature)).filter((d) => d !== void 0), s = Math.min(...t, ...i), a = Math.max(...t, ...i), o = Math.max(a - s, 1), r = this._override("temperature", "temperature"), h = this.hass?.locale?.language ?? navigator.language, l = this._tap("daily");
    return y`
      <div class="panel daily" ?tappable=${!!l}
           @pointerdown=${this._markPointer} @click=${l}>
        <div class="panel-head">${e.length}-DAY FORECAST</div>
        ${e.map((d, p) => {
      const n = $(d.templow), c = $(d.temperature), g = new Date(d.datetime), A = p === 0 ? "Today" : g.toLocaleDateString(h, { weekday: "short" }), b = n === void 0 ? 0 : (n - s) / o * 100, u = n === void 0 || c === void 0 ? 0 : (c - n) / o * 100, v = p === 0 && r !== void 0 ? (r - s) / o * 100 : void 0;
      return y`
            <div class="drow" tappable
                 @pointerdown=${this._markPointer}
                 @click=${(_) => {
        _.stopPropagation(), !this._movedSincePointer(_) && this._openDaySheet(p);
      }}>
              <div class="dday">${A}</div>
              <img class="dicon" src=${this._iconUrl(Y(d.condition, p === 0 && this._isNight))} alt=${d.condition ?? ""} />
              <div class="dlo">${k(n)}°</div>
              <div class="track">
                <div class="bar" style=${`left:${b}%;width:${u}%;background:linear-gradient(90deg, ${Qt(n ?? s)}, ${Qt(c ?? a)})`}></div>
                ${v !== void 0 ? y`<div class="dot" style=${`left:${Math.min(Math.max(v, 0), 100)}%`}></div>` : f}
              </div>
  ...
  _renderDaySheet() {
    ...
    return y`
      <div class="sheet-wrap" @click=${this._closeDaySheet}>
        <div class="sheet" @click=${(h) => h.stopPropagation()}>
          <div class="sheet-head">
            <img class="sheet-head-icon"
                 src=${this._iconUrl(Y(i.condition, !1))} alt="" />
            <span>Conditions</span>
            <button class="sheet-close" title="Close" @click=${this._closeDaySheet}>
              ${D`<svg viewBox="0 0 24 24" width="17" height="17" aria-hidden="true">
      ...
      return y`
                <button class="sday ${l === e ? "on" : ""}"
                        @click=${() => this._openDaySheet(l)}>
                  <span class="sday-w">${d.toLocaleDateString(s, { weekday: "narrow" })}</span>
                  <span class="sday-n">${d.getDate()}</span>
                </button>
              `;
    })}
          </div>
          ...
          <div class="sheet-nav">
            <button class="snav" ?disabled=${e === 0}
              ...
              ${D`<svg viewBox="0 0 24 24" width="18" height="18" aria-hidden="true">
  ...
  _renderSheetBody(e, t, i) {
    ...
    const s = e.map((m) => m.temp), a = Math.max(...s), o = Math.min(...s), r = e[s.indexOf(a)], h = e[s.indexOf(o)], l = 5, d = Math.floor(o / l) * l, p = Math.ceil(a / l) * l, n = Math.max(p - d, l), c = [];
    for (let m = p; m >= d - 1e-3; m -= l) c.push(m);
    const g = e.length, A = (m) => g > 1 ? m / (g - 1) * 100 : 50, b = (m) => (p - m) / n * 100, u = e.map((m, x) => `${A(x)},${b(m.temp)}`).join(" "), v = `0,100 ${u} 100,100`, _ = Math.max(1, Math.round(g / 8));
    return y`
      <div class="sheet-hilo">
        <span class="sheet-hi">${k(a)}°</span><span class="sheet-lo">${k(o)}°</span>
      ...
      <div class="sheet-glyphs">
        ${e.map((m, x) => x % _ === 0 ? y`<img class="sglyph" style=${`left:${A(x)}%`}
                      src=${this._iconUrl(Y(m.condition, this._nightAt(new Date(m.time))))}
                      alt=${m.condition} />` : f)}
      </div>
      ...
      <div class="sheet-chart">
        <div class="sheet-plot">
          ${c.map((m) => y`
            <div class="sgl" style=${`top:${b(m)}%`}></div>`)}
          ...
          <div class="smark lo" style=${`left:${A(e.indexOf(h))}%; top:${b(o)}%`}>
            <span>L</span>
          </div>
        </div>
        <div class="sheet-yaxis">
          ${c.map((m) => y`<span style=${`top:${b(m)}%`}>${k(m)}°</span>`)}
        </div>
      </div>

      <div class="sheet-xaxis">
        ${e.map((m, x) => m.hour % 6 === 0 ? y`<span style=${`left:${A(x)}%`}>${this._hourLabel(m.hour)}</span>` : f)}
      </div>
    `;
  }
  ...
  _renderSunTile(e, t, i) {
    const s = e ? t : i, a = e ? i : t, o = s ? this._fmtTimeParts(s) : { time: "--", suffix: "" }, r = a ? this._fmtTimeParts(a) : { time: "--", suffix: "" }, h = this._sunArc(), l = this._tap("sun");
    return y`
  ...
  _renderTiles() {
    const { rising: e, setting: t } = this._sunTimes(), i = this._override("feels_like", "apparent_temperature"), s = this._override("temperature", "temperature"), a = this._override("humidity", "humidity"), o = this._override("dew_point", "dew_point"), r = this._override("wind_speed", "wind_speed"), h = this._override("wind_gust"), l = this._override("wind_bearing", "wind_bearing"), d = this._override("precipitation_today"), p = this._overrideUnit("wind_speed", "wind_speed_unit") ?? "km/h", n = this._overrideUnit("wind_gust") ?? p, c = e && t ? e < t : !0, g = i === void 0 || s === void 0 ? "" : Math.abs(i - s) < 0.5 ? "Similar to the actual temperature." : i > s ? "It feels warmer than the actual temperature." : "It feels cooler than the actual temperature.", A = this._daily.find((x) => ($(x.precipitation) ?? 0) > 0), b = this.hass?.locale?.language ?? navigator.language, u = A ? $(A.precipitation) ?? 0 : void 0, v = u === void 0 ? "" : `${u < 1 ? "<1" : Math.round(u)} mm`, _ = A ? new Date(A.datetime).toDateString() === (/* @__PURE__ */ new Date()).toDateString() : !1, m = v ? _ ? `${v} more expected today.` : `Next expected is ${v} ${new Date(A.datetime).toLocaleDateString(b, { weekday: "short" })}.` : "None expected in the next 10 days.";
    return y`
        ${this._renderSunTile(c, e, t)}
        ${this._renderWindTile(r, p, h, n, l)}
        ...
        <div class="tile" ?tappable=${!!this._tap("precipitation")}
          ...
          <div class="tile-value">${d === void 0 ? "--" : k(d)} mm</div>
          <div class="tile-sub">Today So Far</div>
          <div class="tile-note">${m}</div>
        </div>
        ...
        <div class="tile" ?tappable=${!!this._tap("humidity")}
          ...
          <div class="tile-note">
            ${o !== void 0 ? y`The dew point is ${k(o)}° right now.` : f}
          </div>
        </div>

        ${this._config?.map ? this._renderMapTile() : f}
    `;
  }
  /**
  ...
  _renderMapTile() {
    ...
    const h = e ? this._mapSeries : void 0, l = h ? Math.min(this._mapFrame, h.frames.length - 1) : 0, d = h ? new Date(h.times[l]) : void 0, p = this._config?.map_style ?? "dark", n = t ? li(t, p) : [];
    return y`
      ...
      c.stopPropagation(), this._toggleMap();
          ...
          ${this._mapOpen && !h?.frames.length ? y`
          ...
          ${this._mapOpen && h?.frames.length && d ? y`
      ...
      return !A && g % 2 !== 0 ? f : y`<span>
          ...
          ${this._mapOpen ? y`<div class="map-credit">${hi}</div>` : f}
        </div>
      </div>
    `;
  }
  ...
  _renderWindTile(e, t, i, s, a) {
    const r = (E) => (E - 90) * Math.PI / 180, h = (E, M) => [48 + E * Math.cos(M), 48 + E * Math.sin(M)];
    let l = "";
    for (let E = 0; E < 72; E++) {
      const M = E * 5;
      if ([0, 90, 180, 270].some((pe) => Math.abs(((M - pe) % 360 + 540) % 360 - 180) > 168)) continue;
      const it = r(M), [he, le] = h(31, it), [de, ce] = h(39, it);
      l += `M${he.toFixed(2)},${le.toFixed(2)}L${de.toFixed(2)},${ce.toFixed(2)}`;
    }
    const d = a !== void 0, p = d ? a + 180 : 0, n = r(p), c = r(p + 180), g = 38, [A, b] = h(g, c), [u, v] = h(g - 3, c), [_, m] = h(24.5, c), [x, tt] = h(22.5, n), [Zt, te] = h(30, n), dt = 1.32, yt = (g + 2 + 30) / 2, wt = (g + 2 - 30) / 2 * dt, [ee, ie] = h(yt + wt, n), [bt, vt] = h(yt - wt, n), xt = -Math.sin(n), _t = Math.cos(n), et = 3.4 * dt, se = bt + xt * et, ae = vt + _t * et, oe = bt - xt * et, re = vt - _t * et, ne = (E) => {
      const M = Math.abs(((p - E) % 360 + 360) % 360);
      return (M > 180 ? 360 - M : M) < 12;
    }, kt = this._tap("wind");
    return y`
          ...
          <svg class="dial" viewBox="0 0 96 96" aria-hidden="true">
            ...
            ${d ? D`
              <line class="dial-shaft" x1=${u.toFixed(2)} y1=${v.toFixed(2)}
                    x2=${_.toFixed(2)} y2=${m.toFixed(2)}></line>
              <line class="dial-shaft" x1=${x.toFixed(2)} y1=${tt.toFixed(2)}
                    x2=${Zt.toFixed(2)} y2=${te.toFixed(2)}></line>
              <circle class="dial-tail" cx=${A.toFixed(2)} cy=${b.toFixed(2)}
                      r=${(3.2 * dt).toFixed(2)}></circle>
              <polygon class="dial-head" points=${`${ee.toFixed(2)},${ie.toFixed(2)} ${se.toFixed(2)},${ae.toFixed(2)} ${oe.toFixed(2)},${re.toFixed(2)}`}></polygon>` : f}
            ...
            ${Ci.map(([E, M, Ct, it]) => d && ne(it) ? f : D`
                  <text class="dial-card" x=${M} y=${Ct} text-anchor="middle"
